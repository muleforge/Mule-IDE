...
/**
 * This is the item provider adapter for a {@link org.mule.ide.config.core.SedaModelType} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class SedaModelTypeItemProvider
	extends AbstractModelTypeItemProvider
	implements	
	 ...
	 * @generated
	 */
	public SedaModelTypeItemProvider(AdapterFactory adapterFactory) {
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_SedaModelType_inherit_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_SedaModelType_inherit_feature", "_UI_SedaModelType_type"),
				 CorePackage.eINSTANCE.getSedaModelType_Inherit(),
				 true,
				 false,
				 false,
	...
	/**
	 * This returns SedaModelType.gif.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/SedaModelType"));
	}
	...
	public String getText(Object object) {
		String label = ((SedaModelType)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_SedaModelType_type") :
			getString("_UI_SedaModelType_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(SedaModelType.class)) {
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(CorePackage.eINSTANCE.getSedaModelType_AbstractQueueProfileGroup(),
