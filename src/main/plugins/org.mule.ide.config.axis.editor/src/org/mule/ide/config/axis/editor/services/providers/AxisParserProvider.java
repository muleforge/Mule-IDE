...
import org.mule.ide.config.axis.editor.services.parsers.MessageFormatParser;
 ...
 * @generated
 */
public class AxisParserProvider extends AbstractProvider implements
		IParserProvider {
	...
	public IParser getParser(IAdaptable hint) {
		...
		if (vid != null) {
			return getParser(AxisVisualIDRegistry.getVisualID(vid));
		}
		View view = (View) hint.getAdapter(View.class);
		if (view != null) {
			return getParser(AxisVisualIDRegistry.getVisualID(view));
		}
		return null;
	}
	...
	public boolean provides(IOperation operation) {
		if (operation instanceof GetParserOperation) {
			...
			if (AxisElementTypes.getElement(hint) == null) {
				return false;
			}
