 ...
 */
public class DefaultServiceExceptionStrategyTypeCreateCommand extends
		SubstitutionElementCreateCommand {

	/**
	 * @generated
	 */
	public DefaultServiceExceptionStrategyTypeCreateCommand(
	...
	protected void addSubstitutionElementReference(EObject container,
		...
		map.add(CorePackage.eINSTANCE
				.getDocumentRoot_DefaultServiceExceptionStrategy(), element);
	}
}
