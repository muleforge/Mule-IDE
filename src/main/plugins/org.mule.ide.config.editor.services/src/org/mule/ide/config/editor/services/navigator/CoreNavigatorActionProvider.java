 ...
 * @generated
 */
public class CoreNavigatorActionProvider extends CommonActionProvider {
	...
	private class OpenDiagramAction extends Action {
		...
		public final void selectionChanged(IStructuredSelection selection) {
			...
			if (selection.size() == 1) {
				...
				if (selectedElement instanceof CoreNavigatorItem) {
					selectedElement = ((CoreNavigatorItem) selectedElement)
							.getView();
				...
				if (selectedElement instanceof Diagram) {
					...
					if (DefaultModelTypeEditPart.MODEL_ID
							.equals(CoreVisualIDRegistry.getModelID(diagram))) {
						myDiagram = diagram;
					}
				}
			}
