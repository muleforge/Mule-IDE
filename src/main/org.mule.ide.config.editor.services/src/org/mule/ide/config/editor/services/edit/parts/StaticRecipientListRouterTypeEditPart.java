...
import org.mule.ide.config.editor.services.edit.policies.StaticRecipientListRouterTypeItemSemanticEditPolicy;
 ...
 * @generated
 */
public class StaticRecipientListRouterTypeEditPart extends ShapeNodeEditPart {
	 ...
	 * @generated
	 */
	public StaticRecipientListRouterTypeEditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new StaticRecipientListRouterTypeItemSemanticEditPolicy());
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof StaticRecipientListRouterTypeLabelEditPart) {
			((StaticRecipientListRouterTypeLabelEditPart) childEditPart)
	...
	protected NodeFigure createNodeFigure() {
		...
		ServiceEditPartUtil.configureServiceItemFigure(figure,
				Messages.StaticRecipientListRouterTypeLabel);
		return figure;
	}
