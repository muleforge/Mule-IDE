 ...
 * <ul>
 *   <li>{@link org.mule.ide.config.spring.impl.PropsTypeImpl#getGroup <em>Group</em>}</li>
 *   <li>{@link org.mule.ide.config.spring.impl.PropsTypeImpl#getProp <em>Prop</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class PropsTypeImpl extends BaseCollectionTypeImpl implements PropsType {
	...
	protected EClass eStaticClass() {
		return SpringPackage.Literals.PROPS_TYPE;
	}
	...
	public FeatureMap getGroup() {
		if (group == null) {
			group = new BasicFeatureMap(this, SpringPackage.PROPS_TYPE__GROUP);
		}
		return group;
	}
	...
	public EList<PropType> getProp() {
		return getGroup().list(SpringPackage.Literals.PROPS_TYPE__PROP);
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			...
			case SpringPackage.PROPS_TYPE__PROP:
