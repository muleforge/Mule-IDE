 ...
 * <ul>
 *   <li>{@link org.mule.ide.config.stdio.impl.OutboundEndpointTypeImpl#getSystem <em>System</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class OutboundEndpointTypeImpl extends org.mule.ide.config.core.impl.OutboundEndpointTypeImpl implements OutboundEndpointType {
	...
	protected EClass eStaticClass() {
		return StdioPackage.Literals.OUTBOUND_ENDPOINT_TYPE;
	}
	...
	public void setSystem(SystemType newSystem) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, StdioPackage.OUTBOUND_ENDPOINT_TYPE__SYSTEM, oldSystem, system, !oldSystemESet));
	}
	...
	public void unsetSystem() {
		...
		systemESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, StdioPackage.OUTBOUND_ENDPOINT_TYPE__SYSTEM, oldSystem, SYSTEM_EDEFAULT, oldSystemESet));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case StdioPackage.OUTBOUND_ENDPOINT_TYPE__SYSTEM:
				return getSystem();
		}
