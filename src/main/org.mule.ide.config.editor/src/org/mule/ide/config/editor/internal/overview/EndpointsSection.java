 ...
 */
public class EndpointsSection extends TableSection 
	...
	private TableViewer fEndpointViewer;
	private Vector fEndpoints;
	private Action fAddAction;
	private Action fRemoveAction;
    private Action fSortAction;
    
    private int fEndpointInsertIndex;
	...
	public EndpointsSection(OverviewPage page, Composite parent, String[] labels) {
	...
	public void createClient(Section section, FormToolkit toolkit) {
		...
		fEndpointViewer = tablePart.getTableViewer();

		fEndpointViewer.setContentProvider(new EndpointContentProvider());
		fEndpointViewer.setLabelProvider(Activator.getDefault().getLabelProvider());
	...
	private void createSectionToolbar(Section section, FormToolkit toolkit) {
		...
		fSortAction = new SortAction(fEndpointViewer, 
				Messages.EndpointsSection_SortAlpha, null, null, this);
	...
	*/
	...
	public boolean setFormInput(Object object) {
		if (object instanceof IPluginImport) {
			...
			fEndpointViewer.setSelection(new StructuredSelection(iobj), true);
			return true;
		}
		return false;
	}
	*/
	...
	protected void fillContextMenu(IMenuManager manager) {
		ISelection selection = fEndpointViewer.getSelection();
		...
		//manager.add(new Separator());
        //if (fPropertiesAction != null && !fEndpointViewer.getSelection().isEmpty()) {
        //    manager.add(new Separator());
	...
	private void handleRemove() {
		// TODO
		/*
		IStructuredSelection ssel = (IStructuredSelection) fEndpointViewer.getSelection();
		IPluginModelBase model = (IPluginModelBase) getPage().getModel();
		IPluginBase pluginBase = model.getPluginBase();
	...
	*/
	...
	public void initialize() {
		...
		if (model == null)
			return;
		fEndpointViewer.setInput(model.getPluginBase());
		*/
        updateButtons();
        /*
	...
	public void refresh() {
		fEndpoints = null;
		fEndpointViewer.refresh();
		super.refresh();
	}

	private void createImportObjects() {
		fEndpoints = new Vector();
		// TODO
		/*
		IPluginModelBase model = (IPluginModelBase) getPage().getModel();
		...
		for (int i = 0; i < iimports.length; i++) {
			...
			fEndpoints.add(new ImportObject(iimport));
		}
		*/
	}
	
	public void setFocus() {
		if (fEndpointViewer != null)
			fEndpointViewer.getTable().setFocus();
	}
	...
	*/
     ...
     * 
     */
    private void resetEnpointInsertIndex() {
    	fEndpointInsertIndex = -1;
    }
    
    /**
     * @param index
     */
    private void setEnpointInsertIndex(int index) {
    	fEndpointInsertIndex = index;
    }
