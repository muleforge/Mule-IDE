 ...
 * <ul>
 *   <li>{@link org.mule.ide.config.axis.impl.OutboundEndpointTypeImpl#getSoapService <em>Soap Service</em>}</li>
 *   <li>{@link org.mule.ide.config.axis.impl.OutboundEndpointTypeImpl#getSoapMethod <em>Soap Method</em>}</li>
 *   <li>{@link org.mule.ide.config.axis.impl.OutboundEndpointTypeImpl#getProperty1 <em>Property1</em>}</li>
 *   <li>{@link org.mule.ide.config.axis.impl.OutboundEndpointTypeImpl#getProperties1 <em>Properties1</em>}</li>
 *   <li>{@link org.mule.ide.config.axis.impl.OutboundEndpointTypeImpl#getClientConfig <em>Client Config</em>}</li>
 *   <li>{@link org.mule.ide.config.axis.impl.OutboundEndpointTypeImpl#getServiceNamespace <em>Service Namespace</em>}</li>
 *   <li>{@link org.mule.ide.config.axis.impl.OutboundEndpointTypeImpl#getSoapAction <em>Soap Action</em>}</li>
 *   <li>{@link org.mule.ide.config.axis.impl.OutboundEndpointTypeImpl#getSOAPAction1 <em>SOAP Action1</em>}</li>
 *   <li>{@link org.mule.ide.config.axis.impl.OutboundEndpointTypeImpl#getStyle <em>Style</em>}</li>
 *   <li>{@link org.mule.ide.config.axis.impl.OutboundEndpointTypeImpl#getUse <em>Use</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class OutboundEndpointTypeImpl extends org.mule.ide.config.core.impl.OutboundEndpointTypeImpl implements OutboundEndpointType {
	/**
	...
	protected EClass eStaticClass() {
		return AxisPackage.Literals.OUTBOUND_ENDPOINT_TYPE;
	}
	...
	public EList<SoapServiceType> getSoapService() {
		if (soapService == null) {
			soapService = new EObjectContainmentEList<SoapServiceType>(SoapServiceType.class, this, AxisPackage.OUTBOUND_ENDPOINT_TYPE__SOAP_SERVICE);
		}
		return soapService;
	}
	...
	public EList<SoapMethodType> getSoapMethod() {
		if (soapMethod == null) {
			soapMethod = new EObjectContainmentEList<SoapMethodType>(SoapMethodType.class, this, AxisPackage.OUTBOUND_ENDPOINT_TYPE__SOAP_METHOD);
		}
		return soapMethod;
	}
	...
	public EList<KeyValueType> getProperty1() {
		if (property1 == null) {
			property1 = new EObjectContainmentEList<KeyValueType>(KeyValueType.class, this, AxisPackage.OUTBOUND_ENDPOINT_TYPE__PROPERTY1);
		}
		return property1;
	}
	...
	public NotificationChain basicSetProperties1(MapType newProperties1, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, AxisPackage.OUTBOUND_ENDPOINT_TYPE__PROPERTIES1, oldProperties1, newProperties1);
	...
	public void setProperties1(MapType newProperties1) {
		if (newProperties1 != properties1) {
			...
			if (properties1 != null)
				msgs = ((InternalEObject)properties1).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - AxisPackage.OUTBOUND_ENDPOINT_TYPE__PROPERTIES1, null, msgs);
			if (newProperties1 != null)
				msgs = ((InternalEObject)newProperties1).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - AxisPackage.OUTBOUND_ENDPOINT_TYPE__PROPERTIES1, null, msgs);
			msgs = basicSetProperties1(newProperties1, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AxisPackage.OUTBOUND_ENDPOINT_TYPE__PROPERTIES1, newProperties1, newProperties1));
	}
	...
	public void setClientConfig(String newClientConfig) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AxisPackage.OUTBOUND_ENDPOINT_TYPE__CLIENT_CONFIG, oldClientConfig, clientConfig));
	}
	...
	public void setServiceNamespace(String newServiceNamespace) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AxisPackage.OUTBOUND_ENDPOINT_TYPE__SERVICE_NAMESPACE, oldServiceNamespace, serviceNamespace));
	}
	...
	public void setSoapAction(String newSoapAction) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AxisPackage.OUTBOUND_ENDPOINT_TYPE__SOAP_ACTION, oldSoapAction, soapAction));
	}
	...
	public void setSOAPAction1(String newSOAPAction1) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AxisPackage.OUTBOUND_ENDPOINT_TYPE__SOAP_ACTION1, oldSOAPAction1, sOAPAction1));
	}
	...
	public void setStyle(StyleType newStyle) {
		...
		styleESet = true;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AxisPackage.OUTBOUND_ENDPOINT_TYPE__STYLE, oldStyle, style, !oldStyleESet));
	}
	...
	public void unsetStyle() {
		...
		styleESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, AxisPackage.OUTBOUND_ENDPOINT_TYPE__STYLE, oldStyle, STYLE_EDEFAULT, oldStyleESet));
	}
	...
	public void setUse(UseType newUse) {
		...
		useESet = true;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AxisPackage.OUTBOUND_ENDPOINT_TYPE__USE, oldUse, use, !oldUseESet));
	}
	...
	public void unsetUse() {
		...
		useESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, AxisPackage.OUTBOUND_ENDPOINT_TYPE__USE, oldUse, USE_EDEFAULT, oldUseESet));
	}
