	...
	protected void addCreateConnectorPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_GlobalEndpointType_createConnector_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_GlobalEndpointType_createConnector_feature", "_UI_GlobalEndpointType_type"),
				 CorePackage.eINSTANCE.getGlobalEndpointType_CreateConnector(),
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
