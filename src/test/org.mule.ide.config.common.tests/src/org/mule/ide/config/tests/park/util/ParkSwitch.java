...
public class ParkSwitch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case ParkPackage.DECAL_TYPE: {
				DecalType decalType = (DecalType)theEObject;
				T result = caseDecalType(decalType);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case ParkPackage.DOCUMENT_ROOT: {
				DocumentRoot documentRoot = (DocumentRoot)theEObject;
				T result = caseDocumentRoot(documentRoot);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case ParkPackage.PARK_TYPE: {
				ParkType parkType = (ParkType)theEObject;
				T result = caseParkType(parkType);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case ParkPackage.VEHICLE_TYPE: {
	 ...
	 * @generated
	 */
	public T caseParkType(ParkType object) {
		return null;
	}
