...
/**
 * <!-- begin-user-doc -->
 * A representation of the model object '<em><b>No Args Call Wrapper Type</b></em>'.
 * <!-- end-user-doc -->
 *
 * <p>
 * The following features are supported:
 * <ul>
 *   <li>{@link org.mule.ide.config.core.NoArgsCallWrapperType#getDelegateClass <em>Delegate Class</em>}</li>
 *   <li>{@link org.mule.ide.config.core.NoArgsCallWrapperType#getDelegateInstance <em>Delegate Instance</em>}</li>
 * </ul>
 * </p>
 *
 * @see org.mule.ide.config.core.CorePackage#getNoArgsCallWrapperType()
 * @model extendedMetaData="name='noArgsCallWrapperType' kind='elementOnly'"
 * @generated
 */
public interface NoArgsCallWrapperType extends DefaultComponentType {
	/**
	 ...
	 * @see org.mule.ide.config.core.CorePackage#getNoArgsCallWrapperType_DelegateClass()
	...
	/**
	 * Sets the value of the '{@link org.mule.ide.config.core.NoArgsCallWrapperType#getDelegateClass <em>Delegate Class</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see org.mule.ide.config.core.CorePackage#getNoArgsCallWrapperType_DelegateInstance()
	 * @model containment="true"
	...
	/**
	 * Sets the value of the '{@link org.mule.ide.config.core.NoArgsCallWrapperType#getDelegateInstance <em>Delegate Instance</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
