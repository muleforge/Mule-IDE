...
import org.mule.ide.config.editor.services.edit.policies.ExceptionOutboundRouterTypeItemSemanticEditPolicy;
 ...
 * @generated
 */
public class ExceptionOutboundRouterTypeEditPart extends ShapeNodeEditPart {
	 ...
	 * @generated
	 */
	public ExceptionOutboundRouterTypeEditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
							...
							if (request instanceof CreateViewAndElementRequest) {
								...
								if (type == CoreElementTypes.OutboundEndpointType_2030) {
									EditPart compartmentEditPart = getChildBySemanticHint(CoreVisualIDRegistry
											.getType(ExceptionOutboundRouterTypeENDPOINTSEditPart.VISUAL_ID));
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new ExceptionOutboundRouterTypeItemSemanticEditPolicy());
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof ExceptionOutboundRouterTypeLabelEditPart) {
			((ExceptionOutboundRouterTypeLabelEditPart) childEditPart)
	...
	protected NodeFigure createNodeFigure() {
		...
		ServiceEditPartUtil.configureServiceItemFigure(figure,
				Messages.ExceptionOutboundRouterTypeLabel);
		return figure;
	}
