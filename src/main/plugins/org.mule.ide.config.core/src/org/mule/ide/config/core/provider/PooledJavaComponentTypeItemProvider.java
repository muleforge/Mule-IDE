...
/**
 * This is the item provider adapter for a {@link org.mule.ide.config.core.PooledJavaComponentType} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class PooledJavaComponentTypeItemProvider
	extends DefaultJavaComponentTypeItemProvider
	implements	
	 ...
	 * @generated
	 */
	public PooledJavaComponentTypeItemProvider(AdapterFactory adapterFactory) {
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(CorePackage.eINSTANCE.getPooledJavaComponentType_AbstractPoolingProfileGroup());
		}
	...
	public String getText(Object object) {
		String label = ((PooledJavaComponentType)object).getClass_();
		return label == null || label.length() == 0 ?
			getString("_UI_PooledJavaComponentType_type") :
			getString("_UI_PooledJavaComponentType_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(PooledJavaComponentType.class)) {
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(CorePackage.eINSTANCE.getPooledJavaComponentType_AbstractPoolingProfileGroup(),
