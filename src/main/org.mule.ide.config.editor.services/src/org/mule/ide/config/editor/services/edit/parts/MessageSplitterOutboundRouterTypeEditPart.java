...
import org.mule.ide.config.editor.services.edit.policies.MessageSplitterOutboundRouterTypeItemSemanticEditPolicy;
 ...
 * @generated
 */
public class MessageSplitterOutboundRouterTypeEditPart extends
		ShapeNodeEditPart {
	 ...
	 * @generated
	 */
	public MessageSplitterOutboundRouterTypeEditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new MessageSplitterOutboundRouterTypeItemSemanticEditPolicy());
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof MessageSplitterOutboundRouterTypeLabelEditPart) {
			((MessageSplitterOutboundRouterTypeLabelEditPart) childEditPart)
	...
	protected NodeFigure createNodeFigure() {
		...
		ServiceEditPartUtil.configureServiceItemFigure(figure,
				Messages.MessageSplitterOutboundRouterTypeLabel);
		return figure;
	}
