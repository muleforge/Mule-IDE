...
/**
 * <!-- begin-user-doc -->
 * A representation of the literals of the enumeration '<em><b>Interface Type1</b></em>',
 * and utility methods for working with them.
 * <!-- end-user-doc -->
 * @see org.mule.ide.config.core.CorePackage#getInterfaceType1()
 * @model extendedMetaData="name='interface_._1_._type'"
 * @generated
 */
public enum InterfaceType1 implements Enumerator {
	/**
	...
	/**
	 * An array of all the '<em><b>Interface Type1</b></em>' enumerators.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	private static final InterfaceType1[] VALUES_ARRAY =
		new InterfaceType1[] {
			MANAGER,
			MODEL,
			SERVICE,
	...
	/**
	 * A public read-only list of all the '<em><b>Interface Type1</b></em>' enumerators.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	public static final List<InterfaceType1> VALUES = Collections.unmodifiableList(Arrays.asList(VALUES_ARRAY));

	/**
	 * Returns the '<em><b>Interface Type1</b></em>' literal with the specified literal value.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	public static InterfaceType1 get(String literal) {
		for (int i = 0; i < VALUES_ARRAY.length; ++i) {
			InterfaceType1 result = VALUES_ARRAY[i];
	...
	/**
	 * Returns the '<em><b>Interface Type1</b></em>' literal with the specified name.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	public static InterfaceType1 getByName(String name) {
		for (int i = 0; i < VALUES_ARRAY.length; ++i) {
			InterfaceType1 result = VALUES_ARRAY[i];
	...
	/**
	 * Returns the '<em><b>Interface Type1</b></em>' literal with the specified integer value.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	public static InterfaceType1 get(int value) {
		switch (value) {
	 ...
	 * @generated
	 */
	private InterfaceType1(int value, String name, String literal) {
		this.value = value;
		this.name = name;
