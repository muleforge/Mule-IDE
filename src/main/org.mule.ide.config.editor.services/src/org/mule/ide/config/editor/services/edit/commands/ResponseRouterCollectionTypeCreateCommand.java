 ...
 * @generated
 */
public class ResponseRouterCollectionTypeCreateCommand extends
		CreateElementCommand {

	/**
	 * @generated
	 */
	public ResponseRouterCollectionTypeCreateCommand(CreateElementRequest req) {
		super(req);
	}
	...
	public boolean canExecute() {
		...
		if (container.getResponseRouter() != null) {
			return false;
		}
		return true;
	}
