...
/**
 * This is the item provider adapter for a {@link org.mule.ide.config.vm.InboundEndpointType} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class InboundEndpointTypeItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_InboundEndpointType_path_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_InboundEndpointType_path_feature", "_UI_InboundEndpointType_type"),
				 VMPackage.Literals.INBOUND_ENDPOINT_TYPE__PATH,
				 true,
				 false,
				 false,
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(InboundEndpointType.class)) {
			case VMPackage.INBOUND_ENDPOINT_TYPE__PATH:
