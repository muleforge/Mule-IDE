...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Vendor Jms Connector Type</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * <ul>
 *   <li>{@link org.mule.ide.config.jms.impl.VendorJmsConnectorTypeImpl#getAcknowledgementMode <em>Acknowledgement Mode</em>}</li>
 *   <li>{@link org.mule.ide.config.jms.impl.VendorJmsConnectorTypeImpl#isCacheJmsSessions <em>Cache Jms Sessions</em>}</li>
 *   <li>{@link org.mule.ide.config.jms.impl.VendorJmsConnectorTypeImpl#getClientId <em>Client Id</em>}</li>
 *   <li>{@link org.mule.ide.config.jms.impl.VendorJmsConnectorTypeImpl#getConnectionFactoryRef <em>Connection Factory Ref</em>}</li>
 *   <li>{@link org.mule.ide.config.jms.impl.VendorJmsConnectorTypeImpl#isDurable <em>Durable</em>}</li>
 *   <li>{@link org.mule.ide.config.jms.impl.VendorJmsConnectorTypeImpl#isEagerConsumer <em>Eager Consumer</em>}</li>
 *   <li>{@link org.mule.ide.config.jms.impl.VendorJmsConnectorTypeImpl#isHonorQosHeaders <em>Honor Qos Headers</em>}</li>
 *   <li>{@link org.mule.ide.config.jms.impl.VendorJmsConnectorTypeImpl#getMaxRedelivery <em>Max Redelivery</em>}</li>
 *   <li>{@link org.mule.ide.config.jms.impl.VendorJmsConnectorTypeImpl#isNoLocal <em>No Local</em>}</li>
 *   <li>{@link org.mule.ide.config.jms.impl.VendorJmsConnectorTypeImpl#getPassword <em>Password</em>}</li>
 *   <li>{@link org.mule.ide.config.jms.impl.VendorJmsConnectorTypeImpl#isPersistentDelivery <em>Persistent Delivery</em>}</li>
 *   <li>{@link org.mule.ide.config.jms.impl.VendorJmsConnectorTypeImpl#isRecoverJmsConnections <em>Recover Jms Connections</em>}</li>
 *   <li>{@link org.mule.ide.config.jms.impl.VendorJmsConnectorTypeImpl#getRedeliveryHandlerRef <em>Redelivery Handler Ref</em>}</li>
 *   <li>{@link org.mule.ide.config.jms.impl.VendorJmsConnectorTypeImpl#getSpecification <em>Specification</em>}</li>
 *   <li>{@link org.mule.ide.config.jms.impl.VendorJmsConnectorTypeImpl#getUsername <em>Username</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class VendorJmsConnectorTypeImpl extends ConnectorTypeImpl implements VendorJmsConnectorType {
	/**
	 ...
	 * @generated
	 */
	protected VendorJmsConnectorTypeImpl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return JMSPackage.Literals.VENDOR_JMS_CONNECTOR_TYPE;
	}
	...
	public void setAcknowledgementMode(AcknowledgementModeType newAcknowledgementMode) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, JMSPackage.VENDOR_JMS_CONNECTOR_TYPE__ACKNOWLEDGEMENT_MODE, oldAcknowledgementMode, acknowledgementMode, !oldAcknowledgementModeESet));
	}
	...
	public void unsetAcknowledgementMode() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, JMSPackage.VENDOR_JMS_CONNECTOR_TYPE__ACKNOWLEDGEMENT_MODE, oldAcknowledgementMode, ACKNOWLEDGEMENT_MODE_EDEFAULT, oldAcknowledgementModeESet));
	}
	...
	public void setCacheJmsSessions(boolean newCacheJmsSessions) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, JMSPackage.VENDOR_JMS_CONNECTOR_TYPE__CACHE_JMS_SESSIONS, oldCacheJmsSessions, cacheJmsSessions, !oldCacheJmsSessionsESet));
	}
	...
	public void unsetCacheJmsSessions() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, JMSPackage.VENDOR_JMS_CONNECTOR_TYPE__CACHE_JMS_SESSIONS, oldCacheJmsSessions, CACHE_JMS_SESSIONS_EDEFAULT, oldCacheJmsSessionsESet));
	}
	...
	public void setClientId(String newClientId) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, JMSPackage.VENDOR_JMS_CONNECTOR_TYPE__CLIENT_ID, oldClientId, clientId));
	}
	...
	public void setConnectionFactoryRef(String newConnectionFactoryRef) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, JMSPackage.VENDOR_JMS_CONNECTOR_TYPE__CONNECTION_FACTORY_REF, oldConnectionFactoryRef, connectionFactoryRef));
	}
	...
	public void setDurable(boolean newDurable) {
		...
		durableESet = true;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, JMSPackage.VENDOR_JMS_CONNECTOR_TYPE__DURABLE, oldDurable, durable, !oldDurableESet));
	}
	...
	public void unsetDurable() {
		...
		durableESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, JMSPackage.VENDOR_JMS_CONNECTOR_TYPE__DURABLE, oldDurable, DURABLE_EDEFAULT, oldDurableESet));
	}
	...
	public void setEagerConsumer(boolean newEagerConsumer) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, JMSPackage.VENDOR_JMS_CONNECTOR_TYPE__EAGER_CONSUMER, oldEagerConsumer, eagerConsumer, !oldEagerConsumerESet));
	}
	...
	public void unsetEagerConsumer() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, JMSPackage.VENDOR_JMS_CONNECTOR_TYPE__EAGER_CONSUMER, oldEagerConsumer, EAGER_CONSUMER_EDEFAULT, oldEagerConsumerESet));
	}
	...
	public void setHonorQosHeaders(boolean newHonorQosHeaders) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, JMSPackage.VENDOR_JMS_CONNECTOR_TYPE__HONOR_QOS_HEADERS, oldHonorQosHeaders, honorQosHeaders, !oldHonorQosHeadersESet));
	}
	...
	public void unsetHonorQosHeaders() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, JMSPackage.VENDOR_JMS_CONNECTOR_TYPE__HONOR_QOS_HEADERS, oldHonorQosHeaders, HONOR_QOS_HEADERS_EDEFAULT, oldHonorQosHeadersESet));
	}
	...
	public void setMaxRedelivery(int newMaxRedelivery) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, JMSPackage.VENDOR_JMS_CONNECTOR_TYPE__MAX_REDELIVERY, oldMaxRedelivery, maxRedelivery, !oldMaxRedeliveryESet));
	}
	...
	public void unsetMaxRedelivery() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, JMSPackage.VENDOR_JMS_CONNECTOR_TYPE__MAX_REDELIVERY, oldMaxRedelivery, MAX_REDELIVERY_EDEFAULT, oldMaxRedeliveryESet));
	}
	...
	public void setNoLocal(boolean newNoLocal) {
		...
		noLocalESet = true;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, JMSPackage.VENDOR_JMS_CONNECTOR_TYPE__NO_LOCAL, oldNoLocal, noLocal, !oldNoLocalESet));
	}
	...
	public void unsetNoLocal() {
		...
		noLocalESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, JMSPackage.VENDOR_JMS_CONNECTOR_TYPE__NO_LOCAL, oldNoLocal, NO_LOCAL_EDEFAULT, oldNoLocalESet));
	}
	...
	public void setPassword(String newPassword) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, JMSPackage.VENDOR_JMS_CONNECTOR_TYPE__PASSWORD, oldPassword, password));
	}
	...
	public void setPersistentDelivery(boolean newPersistentDelivery) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, JMSPackage.VENDOR_JMS_CONNECTOR_TYPE__PERSISTENT_DELIVERY, oldPersistentDelivery, persistentDelivery, !oldPersistentDeliveryESet));
	}
	...
	public void unsetPersistentDelivery() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, JMSPackage.VENDOR_JMS_CONNECTOR_TYPE__PERSISTENT_DELIVERY, oldPersistentDelivery, PERSISTENT_DELIVERY_EDEFAULT, oldPersistentDeliveryESet));
	}
	...
	public void setRecoverJmsConnections(boolean newRecoverJmsConnections) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, JMSPackage.VENDOR_JMS_CONNECTOR_TYPE__RECOVER_JMS_CONNECTIONS, oldRecoverJmsConnections, recoverJmsConnections, !oldRecoverJmsConnectionsESet));
	}
	...
	public void unsetRecoverJmsConnections() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, JMSPackage.VENDOR_JMS_CONNECTOR_TYPE__RECOVER_JMS_CONNECTIONS, oldRecoverJmsConnections, RECOVER_JMS_CONNECTIONS_EDEFAULT, oldRecoverJmsConnectionsESet));
	}
	...
	public void setRedeliveryHandlerRef(String newRedeliveryHandlerRef) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, JMSPackage.VENDOR_JMS_CONNECTOR_TYPE__REDELIVERY_HANDLER_REF, oldRedeliveryHandlerRef, redeliveryHandlerRef));
	}
	...
	public void setSpecification(SpecificationType newSpecification) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, JMSPackage.VENDOR_JMS_CONNECTOR_TYPE__SPECIFICATION, oldSpecification, specification, !oldSpecificationESet));
	}
	...
	public void unsetSpecification() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, JMSPackage.VENDOR_JMS_CONNECTOR_TYPE__SPECIFICATION, oldSpecification, SPECIFICATION_EDEFAULT, oldSpecificationESet));
	}
	...
	public void setUsername(String newUsername) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, JMSPackage.VENDOR_JMS_CONNECTOR_TYPE__USERNAME, oldUsername, username));
	}
