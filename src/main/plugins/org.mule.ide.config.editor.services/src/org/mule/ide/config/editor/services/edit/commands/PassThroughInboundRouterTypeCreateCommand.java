 ...
 */
public class PassThroughInboundRouterTypeCreateCommand extends
		SubstitutionElementCreateCommand {

	/**
	 * @generated
	 */
	public PassThroughInboundRouterTypeCreateCommand(CreateElementRequest req) {
		super(req);
	}
	...
	protected void addSubstitutionElementReference(EObject container,
		...
		map.add(CorePackage.eINSTANCE
				.getDocumentRoot_InboundPassThroughRouter(), element);
	}
}
