 ...
 * <ul>
 *   <li>{@link org.mule.ide.config.vm.impl.InboundEndpointTypeImpl#getPath <em>Path</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class InboundEndpointTypeImpl extends org.mule.ide.config.core.impl.InboundEndpointTypeImpl implements InboundEndpointType {
	...
	protected EClass eStaticClass() {
		return VMPackage.Literals.INBOUND_ENDPOINT_TYPE;
	}
	...
	public void setPath(String newPath) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, VMPackage.INBOUND_ENDPOINT_TYPE__PATH, oldPath, path));
	}
