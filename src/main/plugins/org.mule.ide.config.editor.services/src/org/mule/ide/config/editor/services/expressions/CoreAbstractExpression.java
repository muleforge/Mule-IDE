package org.mule.ide.config.editor.services.expressions;
 ...
 * @generated
 */
public abstract class CoreAbstractExpression {
	...
	private static final boolean DISABLED_NO_IMPL_EXCEPTION_LOG = Boolean
			.valueOf(
					Platform.getDebugOption(ServicesEditorPlugin.getInstance()
	 ...
	 * @generated
	 */
	protected CoreAbstractExpression(EClassifier context) {
		this(null, context);
	}
	 ...
	 * @generated
	 */
	protected CoreAbstractExpression(String body, EClassifier context) {
		this.body = body;
	...
	protected void setStatus(int severity, String message, Throwable throwable) {
		String pluginID = ServicesEditorPlugin.ID;
	 ...
	 * @generated
	 */
	public static final CoreAbstractExpression createNullExpression(
			EClassifier context) {
		return new CoreAbstractExpression(context) {
