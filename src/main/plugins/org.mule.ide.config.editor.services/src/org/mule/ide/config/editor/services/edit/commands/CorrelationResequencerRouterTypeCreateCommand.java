 ...
 */
public class CorrelationResequencerRouterTypeCreateCommand extends
		SubstitutionElementCreateCommand {

	/**
	 * @generated
	 */
	public CorrelationResequencerRouterTypeCreateCommand(
	...
	protected void addSubstitutionElementReference(EObject container,
		...
		map.add(CorePackage.eINSTANCE
				.getDocumentRoot_CorrelationResequencerRouter(), element);
	}
}
