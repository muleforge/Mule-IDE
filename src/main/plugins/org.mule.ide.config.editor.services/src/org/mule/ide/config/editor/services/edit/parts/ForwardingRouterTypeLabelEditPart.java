 ...
 * customization
 */
public class ForwardingRouterTypeLabelEditPart extends
	 ...
	 * @generated
	 */
	public ForwardingRouterTypeLabelEditPart(View view) {
		super(view);
	}
	...
	public IParser getParser() {
		if (parser == null) {
			...
			IAdaptable hintAdapter = new CoreParserProvider.HintAdapter(
					CoreElementTypes.SelectiveConsumerRouterType_2014,
