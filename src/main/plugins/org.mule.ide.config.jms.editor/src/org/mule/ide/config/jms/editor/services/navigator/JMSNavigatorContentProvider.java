 ...
 * @generated
 */
public class JMSNavigatorContentProvider implements ICommonContentProvider {
	 ...
	 * @generated
	 */
	public JMSNavigatorContentProvider() {
	...
	public Object[] getChildren(Object parentElement) {
		if (parentElement instanceof IFile) {
			...
			result.addAll(createNavigatorItems(selectViewsByType(resource
					.getContents(), JMSVisualIDRegistry.MODEL_ID), file,
					false));
			return result.toArray();
		}

		if (parentElement instanceof JMSNavigatorGroup) {
			JMSNavigatorGroup group = (JMSNavigatorGroup) parentElement;
			return group.getChildren();
		}

		if (parentElement instanceof JMSNavigatorItem) {
			JMSNavigatorItem navigatorItem = (JMSNavigatorItem) parentElement;
	...
	private Collection getLinksSourceByType(Collection edges, int visualID) {
		Collection result = new ArrayList();
		String type = JMSVisualIDRegistry.getType(visualID);
	...
	private Collection createNavigatorItems(Collection views, Object parent,
		...
		for (Iterator it = views.iterator(); it.hasNext();) {
			result
					.add(new JMSNavigatorItem((View) it.next(), parent,
							isLeafs));
		}
		return result;
	}
	...
	public Object getParent(Object element) {
		if (element instanceof JMSAbstractNavigatorItem) {
			JMSAbstractNavigatorItem abstractNavigatorItem = (JMSAbstractNavigatorItem) element;
