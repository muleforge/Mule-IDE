 ...
 * @generated
 */
public class CoreDomainNavigatorContentProvider implements
	...
	public Object[] getChildren(Object parentElement) {
		...
		if (parentElement instanceof CoreDomainNavigatorItem) {
			return wrapEObjects(myAdapterFctoryContentProvier
					.getChildren(((CoreDomainNavigatorItem) parentElement)
	...
	public Object[] wrapEObjects(Object[] objects, Object parentElement) {
		...
		for (int i = 0; i < objects.length; i++) {
			if (objects[i] instanceof EObject) {
				result.add(new CoreDomainNavigatorItem((EObject) objects[i],
