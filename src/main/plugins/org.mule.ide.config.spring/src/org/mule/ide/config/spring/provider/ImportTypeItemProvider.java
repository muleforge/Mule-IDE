...
/**
 * This is the item provider adapter for a {@link org.mule.ide.config.spring.ImportType} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ImportTypeItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 getString("_UI_PropertyDescriptor_description", "_UI_ImportType_resource_feature", "_UI_ImportType_type"),
				 SpringPackage.Literals.IMPORT_TYPE__RESOURCE,
				 true,
				 false,
				 false,
	...
	public String getText(Object object) {
		String label = ((ImportType)object).getResource();
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(ImportType.class)) {
			case SpringPackage.IMPORT_TYPE__RESOURCE:
