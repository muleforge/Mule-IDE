...
/**
 * This is the item provider adapter for a {@link org.mule.ide.config.spring.MapType} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class MapTypeItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 SpringPackage.Literals.MAP_TYPE__KEY_TYPE,
				 true,
				 false,
				 false,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(SpringPackage.Literals.MAP_TYPE__GROUP);
		}
	...
	public String getText(Object object) {
		DefaultableBoolean labelValue = ((MapType)object).getMerge();
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(SpringPackage.Literals.MAP_TYPE__GROUP,
				 FeatureMapUtil.createEntry
					(SpringPackage.Literals.MAP_TYPE__ENTRY,
