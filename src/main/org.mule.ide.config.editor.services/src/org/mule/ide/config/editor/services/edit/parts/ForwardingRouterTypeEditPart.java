...
import org.mule.ide.config.editor.services.edit.policies.ForwardingRouterTypeItemSemanticEditPolicy;
...
public class ForwardingRouterTypeEditPart extends ShapeNodeEditPart {
	 ...
	 * @generated
	 */
	public ForwardingRouterTypeEditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new ForwardingRouterTypeItemSemanticEditPolicy());
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof ForwardingRouterTypeLabelEditPart) {
			((ForwardingRouterTypeLabelEditPart) childEditPart)
	...
	protected NodeFigure createNodeFigure() {
		...
		ServiceEditPartUtil.configureServiceItemFigure(figure,
				Messages.ForwardingRouterTypeLabel);
		return figure;
	}
