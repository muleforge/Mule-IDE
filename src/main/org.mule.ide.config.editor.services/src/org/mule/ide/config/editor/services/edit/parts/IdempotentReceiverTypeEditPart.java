...
import org.mule.ide.config.editor.services.edit.policies.IdempotentReceiverTypeItemSemanticEditPolicy;
 ...
 * @generated
 */
public class IdempotentReceiverTypeEditPart extends ShapeNodeEditPart {
	 ...
	 * @generated
	 */
	public IdempotentReceiverTypeEditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new IdempotentReceiverTypeItemSemanticEditPolicy());
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof IdempotentReceiverRouterTypeLabelEditPart) {
			((IdempotentReceiverRouterTypeLabelEditPart) childEditPart)
	...
	protected NodeFigure createNodeFigure() {
		...
		ServiceEditPartUtil.configureServiceItemFigure(figure,
				Messages.IdempotentReceiverRouterTypeLabel);
		return figure;
	}
