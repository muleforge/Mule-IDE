 ...
 * @generated
 */
public class JMSVisualIDRegistry {

	public final static String MODEL_ID = "JMS"; //$NON-NLS-1$

	/**
	 * @generated
	 */
	private static final String DEBUG_KEY = JMSEditorPlugin.getInstance()
	...
	public static String getModelID(View view) {
		...
		if (element != null) {
			if (element.eClass().getEPackage() instanceof JMSPackage) {
				return MODEL_ID;
			}
		}
	...
	public static int getNodeVisualID(View containerView, EObject domainElement) {
		...
		if (CoreVisualIDRegistry.MODEL_ID.equals(containerModelID)) {
			...
			case AsyncReplyCollectionTypeASYNCREPLYROUTERSEditPart.VISUAL_ID:
				...
				if (JMSPackage.eINSTANCE.getInboundEndpointType().isSuperTypeOf(
			...
			default:
				...
				if (CoreVisualIDRegistry.canContain(containerView, domainElement
						.eClass())) {
					if (JMSPackage.eINSTANCE.getOutboundEndpointType().isSuperTypeOf(
							domainElement.eClass())) {
