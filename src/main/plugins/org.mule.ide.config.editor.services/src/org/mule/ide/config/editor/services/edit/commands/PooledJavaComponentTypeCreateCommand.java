 ...
 * customization
 */
public class PooledJavaComponentTypeCreateCommand extends
		CoreElementCreateCommand {

	/**
	 * @generated
	 */
	public PooledJavaComponentTypeCreateCommand(CreateElementRequest req) {
		super(req);
	}
	...
	protected EReference getContainmentReference() {
		return CorePackage.eINSTANCE.getDocumentRoot_PooledComponent();
	}
}
