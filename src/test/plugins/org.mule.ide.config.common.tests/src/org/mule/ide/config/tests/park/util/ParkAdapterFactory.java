 ...
 * @generated
 */
public class ParkAdapterFactory extends AdapterFactoryImpl {
	/**
	 ...
	 * @generated
	 */
	protected static ParkPackage modelPackage;
	 ...
	 * @generated
	 */
	public ParkAdapterFactory() {
		if (modelPackage == null) {
			modelPackage = ParkPackage.eINSTANCE;
		}
	}
	 ...
	 * @generated
	 */
	protected ParkSwitch<Adapter> modelSwitch =
		new ParkSwitch<Adapter>() {
			@Override
			...
			@Override
			public Adapter caseParkType(ParkType object) {
				return createParkTypeAdapter();
			}
			@Override
	...
	/**
	 * Creates a new adapter for an object of class '{@link org.mule.ide.config.tests.park.DecalType <em>Decal Type</em>}'.
	 * <!-- begin-user-doc -->
	...
	/**
	 * Creates a new adapter for an object of class '{@link org.mule.ide.config.tests.park.DocumentRoot <em>Document Root</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	...
	/**
	 * Creates a new adapter for an object of class '{@link org.mule.ide.config.tests.park.ParkType <em>Type</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
	public Adapter createParkTypeAdapter() {
		return null;
	}

	/**
	 * Creates a new adapter for an object of class '{@link org.mule.ide.config.tests.park.VehicleType <em>Vehicle Type</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
