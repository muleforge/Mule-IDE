...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Outbound Endpoint Type</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * <ul>
 *   <li>{@link org.mule.ide.config.core.impl.OutboundEndpointTypeImpl#getGroup <em>Group</em>}</li>
 *   <li>{@link org.mule.ide.config.core.impl.OutboundEndpointTypeImpl#getAbstractTransformerGroup <em>Abstract Transformer Group</em>}</li>
 *   <li>{@link org.mule.ide.config.core.impl.OutboundEndpointTypeImpl#getAbstractTransformer <em>Abstract Transformer</em>}</li>
 *   <li>{@link org.mule.ide.config.core.impl.OutboundEndpointTypeImpl#getTransformers <em>Transformers</em>}</li>
 *   <li>{@link org.mule.ide.config.core.impl.OutboundEndpointTypeImpl#getResponseTransformers <em>Response Transformers</em>}</li>
 *   <li>{@link org.mule.ide.config.core.impl.OutboundEndpointTypeImpl#getAbstractTransactionGroup <em>Abstract Transaction Group</em>}</li>
 *   <li>{@link org.mule.ide.config.core.impl.OutboundEndpointTypeImpl#getAbstractTransaction <em>Abstract Transaction</em>}</li>
 *   <li>{@link org.mule.ide.config.core.impl.OutboundEndpointTypeImpl#getAbstractFilterGroup <em>Abstract Filter Group</em>}</li>
 *   <li>{@link org.mule.ide.config.core.impl.OutboundEndpointTypeImpl#getAbstractFilter <em>Abstract Filter</em>}</li>
 *   <li>{@link org.mule.ide.config.core.impl.OutboundEndpointTypeImpl#getAbstractSecurityFilterGroup <em>Abstract Security Filter Group</em>}</li>
 ...
 *   <li>{@link org.mule.ide.config.core.impl.OutboundEndpointTypeImpl#getCreateConnector <em>Create Connector</em>}</li>
 *   <li>{@link org.mule.ide.config.core.impl.OutboundEndpointTypeImpl#getEncoding <em>Encoding</em>}</li>
 *   <li>{@link org.mule.ide.config.core.impl.OutboundEndpointTypeImpl#getRef <em>Ref</em>}</li>
 *   <li>{@link org.mule.ide.config.core.impl.OutboundEndpointTypeImpl#isRemoteSync <em>Remote Sync</em>}</li>
 *   <li>{@link org.mule.ide.config.core.impl.OutboundEndpointTypeImpl#getRemoteSyncTimeout <em>Remote Sync Timeout</em>}</li>
 *   <li>{@link org.mule.ide.config.core.impl.OutboundEndpointTypeImpl#getResponseTransformerRefs <em>Response Transformer Refs</em>}</li>
 *   <li>{@link org.mule.ide.config.core.impl.OutboundEndpointTypeImpl#isSynchronous <em>Synchronous</em>}</li>
 *   <li>{@link org.mule.ide.config.core.impl.OutboundEndpointTypeImpl#getTransformerRefs <em>Transformer Refs</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class OutboundEndpointTypeImpl extends AbstractOutboundEndpointTypeImpl implements OutboundEndpointType {
	/**
	 ...
	 * @generated
	 */
	protected OutboundEndpointTypeImpl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return CorePackage.eINSTANCE.getOutboundEndpointType();
	}
	...
	public FeatureMap getGroup() {
		if (group == null) {
			group = new BasicFeatureMap(this, CorePackage.OUTBOUND_ENDPOINT_TYPE__GROUP);
		}
		return group;
	}
	...
	public FeatureMap getAbstractTransformerGroup() {
		return (FeatureMap)getGroup().<FeatureMap.Entry>list(CorePackage.eINSTANCE.getOutboundEndpointType_AbstractTransformerGroup());
	}
	...
	public EList<AbstractTransformerType> getAbstractTransformer() {
		return getAbstractTransformerGroup().list(CorePackage.eINSTANCE.getOutboundEndpointType_AbstractTransformer());
	}
	...
	public EList<TransformersType> getTransformers() {
		return getGroup().list(CorePackage.eINSTANCE.getOutboundEndpointType_Transformers());
	}
	...
	public EList<ResponseTransformersType> getResponseTransformers() {
		return getGroup().list(CorePackage.eINSTANCE.getOutboundEndpointType_ResponseTransformers());
	}
	...
	public FeatureMap getAbstractTransactionGroup() {
		return (FeatureMap)getGroup().<FeatureMap.Entry>list(CorePackage.eINSTANCE.getOutboundEndpointType_AbstractTransactionGroup());
	}
	...
	public EList<AbstractTransactionType> getAbstractTransaction() {
		return getAbstractTransactionGroup().list(CorePackage.eINSTANCE.getOutboundEndpointType_AbstractTransaction());
	}
	...
	public FeatureMap getAbstractFilterGroup() {
		return (FeatureMap)getGroup().<FeatureMap.Entry>list(CorePackage.eINSTANCE.getOutboundEndpointType_AbstractFilterGroup());
	}
	...
	public EList<AbstractFilterType> getAbstractFilter() {
		return getAbstractFilterGroup().list(CorePackage.eINSTANCE.getOutboundEndpointType_AbstractFilter());
	}
	...
	public FeatureMap getAbstractSecurityFilterGroup() {
		return (FeatureMap)getGroup().<FeatureMap.Entry>list(CorePackage.eINSTANCE.getOutboundEndpointType_AbstractSecurityFilterGroup());
	}
	...
	public EList<AbstractSecurityFilterType> getAbstractSecurityFilter() {
		return getAbstractSecurityFilterGroup().list(CorePackage.eINSTANCE.getOutboundEndpointType_AbstractSecurityFilter());
	}
	...
	public FeatureMap getAbstractConnectionStrategyGroup() {
		return (FeatureMap)getGroup().<FeatureMap.Entry>list(CorePackage.eINSTANCE.getOutboundEndpointType_AbstractConnectionStrategyGroup());
	}
	...
	public EList<AbstractConnectionStrategyType> getAbstractConnectionStrategy() {
		return getAbstractConnectionStrategyGroup().list(CorePackage.eINSTANCE.getOutboundEndpointType_AbstractConnectionStrategy());
	}
	...
	public void setAddress(String newAddress) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CorePackage.OUTBOUND_ENDPOINT_TYPE__ADDRESS, oldAddress, address));
	}
	...
	public void setConnectorRef(String newConnectorRef) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CorePackage.OUTBOUND_ENDPOINT_TYPE__CONNECTOR_REF, oldConnectorRef, connectorRef));
	}
	...
	public void setCreateConnector(CreateConnectorType newCreateConnector) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CorePackage.OUTBOUND_ENDPOINT_TYPE__CREATE_CONNECTOR, oldCreateConnector, createConnector, !oldCreateConnectorESet));
	}
	...
	public void unsetCreateConnector() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, CorePackage.OUTBOUND_ENDPOINT_TYPE__CREATE_CONNECTOR, oldCreateConnector, CREATE_CONNECTOR_EDEFAULT, oldCreateConnectorESet));
	}
	...
	public void setEncoding(String newEncoding) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CorePackage.OUTBOUND_ENDPOINT_TYPE__ENCODING, oldEncoding, encoding));
	}
	...
	public void setRef(String newRef) {
		...
		ref = newRef;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CorePackage.OUTBOUND_ENDPOINT_TYPE__REF, oldRef, ref));
	}
	...
	public void setRemoteSync(boolean newRemoteSync) {
		...
		remoteSyncESet = true;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CorePackage.OUTBOUND_ENDPOINT_TYPE__REMOTE_SYNC, oldRemoteSync, remoteSync, !oldRemoteSyncESet));
	}
	...
	public void unsetRemoteSync() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, CorePackage.OUTBOUND_ENDPOINT_TYPE__REMOTE_SYNC, oldRemoteSync, REMOTE_SYNC_EDEFAULT, oldRemoteSyncESet));
	}
	...
	public void setResponseTransformerRefs(List<String> newResponseTransformerRefs) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CorePackage.OUTBOUND_ENDPOINT_TYPE__RESPONSE_TRANSFORMER_REFS, oldResponseTransformerRefs, responseTransformerRefs));
	}
	...
	public void setSynchronous(boolean newSynchronous) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CorePackage.OUTBOUND_ENDPOINT_TYPE__SYNCHRONOUS, oldSynchronous, synchronous, !oldSynchronousESet));
	}
	...
	public void unsetSynchronous() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, CorePackage.OUTBOUND_ENDPOINT_TYPE__SYNCHRONOUS, oldSynchronous, SYNCHRONOUS_EDEFAULT, oldSynchronousESet));
	}
	...
	public void setTransformerRefs(List<String> newTransformerRefs) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CorePackage.OUTBOUND_ENDPOINT_TYPE__TRANSFORMER_REFS, oldTransformerRefs, transformerRefs));
	}
