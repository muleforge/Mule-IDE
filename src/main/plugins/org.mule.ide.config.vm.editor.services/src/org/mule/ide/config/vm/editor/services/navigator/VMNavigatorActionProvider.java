...
import org.mule.ide.config.vm.editor.services.part.VMDiagramEditor;
 ...
 * @generated
 */
public class VMNavigatorActionProvider extends CommonActionProvider {
	...
	private class OpenDiagramAction extends Action {
		...
		public final void selectionChanged(IStructuredSelection selection) {
			...
			if (selection.size() == 1) {
				...
				if (selectedElement instanceof VMNavigatorItem) {
					selectedElement = ((VMNavigatorItem) selectedElement)
							.getView();
				...
				if (selectedElement instanceof Diagram) {
					...
					if (DefaultModelTypeEditPart.MODEL_ID
							.equals(VMVisualIDRegistry.getModelID(diagram))) {
						myDiagram = diagram;
					}
				}
			}
		...
		public void run() {
			...
			try {
				page.openEditor(editorInput, VMDiagramEditor.ID);
