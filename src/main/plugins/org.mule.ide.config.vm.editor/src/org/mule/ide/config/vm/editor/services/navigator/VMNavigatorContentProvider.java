 ...
 * @generated
 */
public class VMNavigatorContentProvider implements ICommonContentProvider {
	 ...
	 * @generated
	 */
	public VMNavigatorContentProvider() {
	...
	public Object[] getChildren(Object parentElement) {
		if (parentElement instanceof IFile) {
			...
			result.addAll(createNavigatorItems(selectViewsByType(resource
					.getContents(), VMVisualIDRegistry.MODEL_ID), file,
					false));
			return result.toArray();
		}

		if (parentElement instanceof VMNavigatorGroup) {
			VMNavigatorGroup group = (VMNavigatorGroup) parentElement;
			return group.getChildren();
		}

		if (parentElement instanceof VMNavigatorItem) {
			VMNavigatorItem navigatorItem = (VMNavigatorItem) parentElement;
	...
	private Collection getLinksSourceByType(Collection edges, int visualID) {
		Collection result = new ArrayList();
		String type = VMVisualIDRegistry.getType(visualID);
	...
	private Collection createNavigatorItems(Collection views, Object parent,
		...
		Collection result = new ArrayList();
		for (Iterator it = views.iterator(); it.hasNext();) {
			result.add(new VMNavigatorItem((View) it.next(), parent, isLeafs));
		}
		return result;
	}
	...
	public Object getParent(Object element) {
		if (element instanceof VMAbstractNavigatorItem) {
			VMAbstractNavigatorItem abstractNavigatorItem = (VMAbstractNavigatorItem) element;
