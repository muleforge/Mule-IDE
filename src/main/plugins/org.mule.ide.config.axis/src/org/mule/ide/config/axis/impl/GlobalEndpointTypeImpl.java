 ...
 * <ul>
 *   <li>{@link org.mule.ide.config.axis.impl.GlobalEndpointTypeImpl#getOptions <em>Options</em>}</li>
 *   <li>{@link org.mule.ide.config.axis.impl.GlobalEndpointTypeImpl#getBeanType <em>Bean Type</em>}</li>
 *   <li>{@link org.mule.ide.config.axis.impl.GlobalEndpointTypeImpl#getSoapService <em>Soap Service</em>}</li>
 *   <li>{@link org.mule.ide.config.axis.impl.GlobalEndpointTypeImpl#getSoapMethod <em>Soap Method</em>}</li>
 *   <li>{@link org.mule.ide.config.axis.impl.GlobalEndpointTypeImpl#getProperty1 <em>Property1</em>}</li>
 *   <li>{@link org.mule.ide.config.axis.impl.GlobalEndpointTypeImpl#getProperties1 <em>Properties1</em>}</li>
 *   <li>{@link org.mule.ide.config.axis.impl.GlobalEndpointTypeImpl#getClientConfig <em>Client Config</em>}</li>
 *   <li>{@link org.mule.ide.config.axis.impl.GlobalEndpointTypeImpl#getServiceNamespace <em>Service Namespace</em>}</li>
 *   <li>{@link org.mule.ide.config.axis.impl.GlobalEndpointTypeImpl#getSoapAction <em>Soap Action</em>}</li>
 *   <li>{@link org.mule.ide.config.axis.impl.GlobalEndpointTypeImpl#getSOAPAction1 <em>SOAP Action1</em>}</li>
 *   <li>{@link org.mule.ide.config.axis.impl.GlobalEndpointTypeImpl#getStyle <em>Style</em>}</li>
 *   <li>{@link org.mule.ide.config.axis.impl.GlobalEndpointTypeImpl#getUse <em>Use</em>}</li>
 *   <li>{@link org.mule.ide.config.axis.impl.GlobalEndpointTypeImpl#getWsdlFile <em>Wsdl File</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class GlobalEndpointTypeImpl extends org.mule.ide.config.core.impl.GlobalEndpointTypeImpl implements GlobalEndpointType {
	/**
	...
	protected EClass eStaticClass() {
		return AxisPackage.Literals.GLOBAL_ENDPOINT_TYPE;
	}
	...
	public NotificationChain basicSetOptions(OptionsType newOptions, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, AxisPackage.GLOBAL_ENDPOINT_TYPE__OPTIONS, oldOptions, newOptions);
	...
	public void setOptions(OptionsType newOptions) {
		if (newOptions != options) {
			...
			if (options != null)
				msgs = ((InternalEObject)options).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - AxisPackage.GLOBAL_ENDPOINT_TYPE__OPTIONS, null, msgs);
			if (newOptions != null)
				msgs = ((InternalEObject)newOptions).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - AxisPackage.GLOBAL_ENDPOINT_TYPE__OPTIONS, null, msgs);
			msgs = basicSetOptions(newOptions, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AxisPackage.GLOBAL_ENDPOINT_TYPE__OPTIONS, newOptions, newOptions));
	}
	...
	public EList<BeanTypeType> getBeanType() {
		if (beanType == null) {
			beanType = new EObjectContainmentEList<BeanTypeType>(BeanTypeType.class, this, AxisPackage.GLOBAL_ENDPOINT_TYPE__BEAN_TYPE);
		}
		return beanType;
	}
	...
	public EList<SoapServiceType> getSoapService() {
		if (soapService == null) {
			soapService = new EObjectContainmentEList<SoapServiceType>(SoapServiceType.class, this, AxisPackage.GLOBAL_ENDPOINT_TYPE__SOAP_SERVICE);
		}
		return soapService;
	}
	...
	public EList<SoapMethodType> getSoapMethod() {
		if (soapMethod == null) {
			soapMethod = new EObjectContainmentEList<SoapMethodType>(SoapMethodType.class, this, AxisPackage.GLOBAL_ENDPOINT_TYPE__SOAP_METHOD);
		}
		return soapMethod;
	}
	...
	public EList<KeyValueType> getProperty1() {
		if (property1 == null) {
			property1 = new EObjectContainmentEList<KeyValueType>(KeyValueType.class, this, AxisPackage.GLOBAL_ENDPOINT_TYPE__PROPERTY1);
		}
		return property1;
	}
	...
	public NotificationChain basicSetProperties1(MapType newProperties1, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, AxisPackage.GLOBAL_ENDPOINT_TYPE__PROPERTIES1, oldProperties1, newProperties1);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setProperties1(MapType newProperties1) {
		if (newProperties1 != properties1) {
			NotificationChain msgs = null;
			if (properties1 != null)
				msgs = ((InternalEObject)properties1).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - AxisPackage.GLOBAL_ENDPOINT_TYPE__PROPERTIES1, null, msgs);
			if (newProperties1 != null)
				msgs = ((InternalEObject)newProperties1).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - AxisPackage.GLOBAL_ENDPOINT_TYPE__PROPERTIES1, null, msgs);
			msgs = basicSetProperties1(newProperties1, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AxisPackage.GLOBAL_ENDPOINT_TYPE__PROPERTIES1, newProperties1, newProperties1));
	}
	...
	public void setClientConfig(String newClientConfig) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AxisPackage.GLOBAL_ENDPOINT_TYPE__CLIENT_CONFIG, oldClientConfig, clientConfig));
	}
	...
	public void setServiceNamespace(String newServiceNamespace) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AxisPackage.GLOBAL_ENDPOINT_TYPE__SERVICE_NAMESPACE, oldServiceNamespace, serviceNamespace));
	}
	...
	public void setSoapAction(String newSoapAction) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AxisPackage.GLOBAL_ENDPOINT_TYPE__SOAP_ACTION, oldSoapAction, soapAction));
	}
	...
	public void setSOAPAction1(String newSOAPAction1) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AxisPackage.GLOBAL_ENDPOINT_TYPE__SOAP_ACTION1, oldSOAPAction1, sOAPAction1));
	}
	...
	public void setStyle(StyleType newStyle) {
		...
		styleESet = true;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AxisPackage.GLOBAL_ENDPOINT_TYPE__STYLE, oldStyle, style, !oldStyleESet));
	}
	...
	public void unsetStyle() {
		...
		styleESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, AxisPackage.GLOBAL_ENDPOINT_TYPE__STYLE, oldStyle, STYLE_EDEFAULT, oldStyleESet));
	}
	...
	public void setUse(UseType newUse) {
		...
		useESet = true;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AxisPackage.GLOBAL_ENDPOINT_TYPE__USE, oldUse, use, !oldUseESet));
	}
	...
	public void unsetUse() {
		...
		useESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, AxisPackage.GLOBAL_ENDPOINT_TYPE__USE, oldUse, USE_EDEFAULT, oldUseESet));
	}
	...
	public void setWsdlFile(String newWsdlFile) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AxisPackage.GLOBAL_ENDPOINT_TYPE__WSDL_FILE, oldWsdlFile, wsdlFile));
	}
