...
import org.mule.ide.config.editor.services.edit.policies.TemplateEndpointOutboundRouterTypeItemSemanticEditPolicy;
 ...
 * @generated
 */
public class TemplateEndpointOutboundRouterTypeEditPart extends
		ShapeNodeEditPart {
	 ...
	 * @generated
	 */
	public TemplateEndpointOutboundRouterTypeEditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new TemplateEndpointOutboundRouterTypeItemSemanticEditPolicy());
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof TemplateEndpointOutboundRouterTypeLabelEditPart) {
			((TemplateEndpointOutboundRouterTypeLabelEditPart) childEditPart)
	...
	protected NodeFigure createNodeFigure() {
		...
		ServiceEditPartUtil.configureServiceItemFigure(figure,
				Messages.TemplateEndpointOutboundRouterTypeLabel);
		return figure;
	}
