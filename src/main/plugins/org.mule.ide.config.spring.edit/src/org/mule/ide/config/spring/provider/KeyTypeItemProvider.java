...
/**
 * This is the item provider adapter for a {@link org.mule.ide.config.spring.KeyType} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class KeyTypeItemProvider
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(SpringPackage.Literals.KEY_TYPE__GROUP);
		}
	...
	public String getText(Object object) {
		return getString("_UI_KeyType_type");
	}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(SpringPackage.Literals.KEY_TYPE__GROUP,
				 FeatureMapUtil.createEntry
					(SpringPackage.Literals.KEY_TYPE__BEAN,
		...
		newChildDescriptors.add
			(createChildParameter
				(SpringPackage.Literals.KEY_TYPE__GROUP,
				 FeatureMapUtil.createEntry
					(SpringPackage.Literals.KEY_TYPE__REF,
		...
		newChildDescriptors.add
			(createChildParameter
				(SpringPackage.Literals.KEY_TYPE__GROUP,
				 FeatureMapUtil.createEntry
					(SpringPackage.Literals.KEY_TYPE__IDREF,
		...
		newChildDescriptors.add
			(createChildParameter
				(SpringPackage.Literals.KEY_TYPE__GROUP,
				 FeatureMapUtil.createEntry
					(SpringPackage.Literals.KEY_TYPE__VALUE,
		...
		newChildDescriptors.add
			(createChildParameter
				(SpringPackage.Literals.KEY_TYPE__GROUP,
				 FeatureMapUtil.createEntry
					(SpringPackage.Literals.KEY_TYPE__NULL,
		...
		newChildDescriptors.add
			(createChildParameter
				(SpringPackage.Literals.KEY_TYPE__GROUP,
				 FeatureMapUtil.createEntry
					(SpringPackage.Literals.KEY_TYPE__LIST,
		...
		newChildDescriptors.add
			(createChildParameter
				(SpringPackage.Literals.KEY_TYPE__GROUP,
				 FeatureMapUtil.createEntry
					(SpringPackage.Literals.KEY_TYPE__SET,
					 SpringFactory.eINSTANCE.createListOrSetType())));
		...
		newChildDescriptors.add
			(createChildParameter
				(SpringPackage.Literals.KEY_TYPE__GROUP,
				 FeatureMapUtil.createEntry
					(SpringPackage.Literals.KEY_TYPE__MAP,
		...
		newChildDescriptors.add
			(createChildParameter
				(SpringPackage.Literals.KEY_TYPE__GROUP,
				 FeatureMapUtil.createEntry
					(SpringPackage.Literals.KEY_TYPE__PROPS,
	...
	public String getCreateChildText(Object owner, Object feature, Object child, Collection<?> selection) {
		...
		boolean qualify =
			childFeature == SpringPackage.Literals.KEY_TYPE__LIST ||
			childFeature == SpringPackage.Literals.KEY_TYPE__SET;
