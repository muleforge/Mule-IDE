...
{
    /**
     * XPath re-invented to be maximally compatible. About as popular as reinventing
     * the wheel. Bugger!
     * 
     * @param element to use as a starting point
     * @param path simple "xpath-like" expression, sans namespaces (uses only local
     *            part)
    ...
    {
        // If we matched all the way to the leaf of the path, add the element to the
        // destination....
        ...
        // OK, we have a match on the path so far, now check rest of the path
        // (possibly none)
