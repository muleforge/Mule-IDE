...
import org.mule.ide.config.jms.editor.services.edit.policies.InboundEndpointServiceItemTypeItemSemanticEditPolicy;
import org.mule.ide.config.jms.editor.services.part.JMSVisualIDRegistry;
import org.mule.ide.config.jms.editor.services.part.Messages;
...
public class InboundEndpointServiceItemTypeEditPart extends ServiceItemNodeEditPart {
			...
			protected EditPolicy createChildEditPolicy(EditPart child) {
				if (child.getEditPolicy(EditPolicy.PRIMARY_DRAG_ROLE) == null) {
					if (child instanceof ITextAwareEditPart) {
						return new JMSTextSelectionEditPolicy();
					}
				}
	...
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(JMSVisualIDRegistry
