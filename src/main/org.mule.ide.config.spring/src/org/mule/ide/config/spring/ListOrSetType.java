...
/**
 * <!-- begin-user-doc -->
 * A representation of the model object '<em><b>List Or Set Type</b></em>'.
 * <!-- end-user-doc -->
 *
 * <p>
 * The following features are supported:
 * <ul>
 *   <li>{@link org.mule.ide.config.spring.ListOrSetType#getGroup <em>Group</em>}</li>
 *   <li>{@link org.mule.ide.config.spring.ListOrSetType#getBean <em>Bean</em>}</li>
 *   <li>{@link org.mule.ide.config.spring.ListOrSetType#getRef <em>Ref</em>}</li>
 *   <li>{@link org.mule.ide.config.spring.ListOrSetType#getIdref <em>Idref</em>}</li>
 *   <li>{@link org.mule.ide.config.spring.ListOrSetType#getValue <em>Value</em>}</li>
 *   <li>{@link org.mule.ide.config.spring.ListOrSetType#getNull <em>Null</em>}</li>
 *   <li>{@link org.mule.ide.config.spring.ListOrSetType#getList <em>List</em>}</li>
 *   <li>{@link org.mule.ide.config.spring.ListOrSetType#getSet <em>Set</em>}</li>
 *   <li>{@link org.mule.ide.config.spring.ListOrSetType#getMap <em>Map</em>}</li>
 *   <li>{@link org.mule.ide.config.spring.ListOrSetType#getProps <em>Props</em>}</li>
 *   <li>{@link org.mule.ide.config.spring.ListOrSetType#getAny <em>Any</em>}</li>
 * </ul>
 * </p>
 *
 * @see org.mule.ide.config.spring.SpringPackage#getListOrSetType()
 * @model extendedMetaData="name='listOrSetType' kind='elementOnly'"
 * @generated
 */
public interface ListOrSetType extends TypedCollectionType {
	/**
	 ...
	 * @see org.mule.ide.config.spring.SpringPackage#getListOrSetType_Group()
	 ...
	 * @see org.mule.ide.config.spring.SpringPackage#getListOrSetType_Bean()
	 * @model containment="true" transient="true" volatile="true" derived="true"
	 *        extendedMetaData="kind='element' name='bean' namespace='##targetNamespace' group='#group:2'"
	 * @generated
	 */
	 ...
	 * @see org.mule.ide.config.spring.SpringPackage#getListOrSetType_Ref()
	 * @model containment="true" transient="true" volatile="true" derived="true"
	 *        extendedMetaData="kind='element' name='ref' namespace='##targetNamespace' group='#group:2'"
	 * @generated
	 */
	 ...
	 * @see org.mule.ide.config.spring.SpringPackage#getListOrSetType_Idref()
	 * @model containment="true" transient="true" volatile="true" derived="true"
	 *        extendedMetaData="kind='element' name='idref' namespace='##targetNamespace' group='#group:2'"
	 * @generated
	 */
	 ...
	 * @see org.mule.ide.config.spring.SpringPackage#getListOrSetType_Value()
	 * @model containment="true" transient="true" volatile="true" derived="true"
	 ...
	 * @see org.mule.ide.config.spring.SpringPackage#getListOrSetType_Null()
	 * @model containment="true" transient="true" volatile="true" derived="true"
	 *        extendedMetaData="kind='element' name='null' namespace='##targetNamespace' group='#group:2'"
	 * @generated
	 */
	 ...
	 * @see org.mule.ide.config.spring.SpringPackage#getListOrSetType_List()
	 * @model containment="true" transient="true" volatile="true" derived="true"
	 *        extendedMetaData="kind='element' name='list' namespace='##targetNamespace' group='#group:2'"
	 * @generated
	 */
	 ...
	 * @see org.mule.ide.config.spring.SpringPackage#getListOrSetType_Set()
	 * @model containment="true" transient="true" volatile="true" derived="true"
	 *        extendedMetaData="kind='element' name='set' namespace='##targetNamespace' group='#group:2'"
	 * @generated
	 */
	 ...
	 * @see org.mule.ide.config.spring.SpringPackage#getListOrSetType_Map()
	 * @model containment="true" transient="true" volatile="true" derived="true"
	 ...
	 * @see org.mule.ide.config.spring.SpringPackage#getListOrSetType_Props()
	 * @model containment="true" transient="true" volatile="true" derived="true"
	 *        extendedMetaData="kind='element' name='props' namespace='##targetNamespace' group='#group:2'"
	 * @generated
	 */
	 ...
	 * @see org.mule.ide.config.spring.SpringPackage#getListOrSetType_Any()
	 * @model unique="false" dataType="org.eclipse.emf.ecore.EFeatureMapEntry" many="true" transient="true" volatile="true" derived="true"
	 *        extendedMetaData="kind='elementWildcard' wildcards='##other' name=':12' processing='strict' group='#group:2'"
	 * @generated
	 */
	FeatureMap getAny();
