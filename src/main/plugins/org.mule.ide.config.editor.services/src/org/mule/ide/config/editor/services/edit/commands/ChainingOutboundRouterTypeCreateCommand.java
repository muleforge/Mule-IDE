 ...
 * customization
 */
public class ChainingOutboundRouterTypeCreateCommand extends
		CoreElementCreateCommand {

	/**
	 * @generated
	 */
	public ChainingOutboundRouterTypeCreateCommand(CreateElementRequest req) {
		super(req);
	}
	...
	protected EReference getContainmentReference() {
		return CorePackage.eINSTANCE.getDocumentRoot_ChainingRouter();
	}
}
