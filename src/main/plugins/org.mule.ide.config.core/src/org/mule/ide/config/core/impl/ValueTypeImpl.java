 ...
 * <ul>
 *   <li>{@link org.mule.ide.config.core.impl.ValueTypeImpl#getValue <em>Value</em>}</li>
 *   <li>{@link org.mule.ide.config.core.impl.ValueTypeImpl#getValueRef <em>Value Ref</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ValueTypeImpl extends EObjectImpl implements ValueType {
	...
	protected EClass eStaticClass() {
		return CorePackage.eINSTANCE.getValueType();
	}
	...
	public void setValue(String newValue) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CorePackage.VALUE_TYPE__VALUE, oldValue, value));
	}
	...
	public void setValueRef(String newValueRef) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CorePackage.VALUE_TYPE__VALUE_REF, oldValueRef, valueRef));
	}
