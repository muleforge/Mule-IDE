...
import org.mule.ide.config.core.impl.AbstractGlobalEndpointTypeImpl;
 ...
 * <ul>
 *   <li>{@link org.mule.ide.config.jms.impl.GlobalEndpointTypeImpl#getGroup <em>Group</em>}</li>
 *   <li>{@link org.mule.ide.config.jms.impl.GlobalEndpointTypeImpl#getAbstractTransformerGroup <em>Abstract Transformer Group</em>}</li>
 *   <li>{@link org.mule.ide.config.jms.impl.GlobalEndpointTypeImpl#getAbstractTransformer <em>Abstract Transformer</em>}</li>
 *   <li>{@link org.mule.ide.config.jms.impl.GlobalEndpointTypeImpl#getTransformers <em>Transformers</em>}</li>
 *   <li>{@link org.mule.ide.config.jms.impl.GlobalEndpointTypeImpl#getResponseTransformers <em>Response Transformers</em>}</li>
 *   <li>{@link org.mule.ide.config.jms.impl.GlobalEndpointTypeImpl#getAbstractTransactionGroup <em>Abstract Transaction Group</em>}</li>
 *   <li>{@link org.mule.ide.config.jms.impl.GlobalEndpointTypeImpl#getAbstractTransaction <em>Abstract Transaction</em>}</li>
 *   <li>{@link org.mule.ide.config.jms.impl.GlobalEndpointTypeImpl#getAbstractFilterGroup <em>Abstract Filter Group</em>}</li>
 *   <li>{@link org.mule.ide.config.jms.impl.GlobalEndpointTypeImpl#getAbstractFilter <em>Abstract Filter</em>}</li>
 ...
 *   <li>{@link org.mule.ide.config.jms.impl.GlobalEndpointTypeImpl#getEncoding <em>Encoding</em>}</li>
 *   <li>{@link org.mule.ide.config.jms.impl.GlobalEndpointTypeImpl#getQueue <em>Queue</em>}</li>
 *   <li>{@link org.mule.ide.config.jms.impl.GlobalEndpointTypeImpl#getRef <em>Ref</em>}</li>
 *   <li>{@link org.mule.ide.config.jms.impl.GlobalEndpointTypeImpl#isRemoteSync <em>Remote Sync</em>}</li>
 *   <li>{@link org.mule.ide.config.jms.impl.GlobalEndpointTypeImpl#getRemoteSyncTimeout <em>Remote Sync Timeout</em>}</li>
 *   <li>{@link org.mule.ide.config.jms.impl.GlobalEndpointTypeImpl#getResponseTransformerRefs <em>Response Transformer Refs</em>}</li>
 *   <li>{@link org.mule.ide.config.jms.impl.GlobalEndpointTypeImpl#isSynchronous <em>Synchronous</em>}</li>
 *   <li>{@link org.mule.ide.config.jms.impl.GlobalEndpointTypeImpl#getTopic <em>Topic</em>}</li>
 *   <li>{@link org.mule.ide.config.jms.impl.GlobalEndpointTypeImpl#getTransformerRefs <em>Transformer Refs</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class GlobalEndpointTypeImpl extends AbstractGlobalEndpointTypeImpl implements GlobalEndpointType {
	/**
	...
	protected EClass eStaticClass() {
		return JMSPackage.Literals.GLOBAL_ENDPOINT_TYPE;
	}
	...
	public FeatureMap getGroup() {
		if (group == null) {
			group = new BasicFeatureMap(this, JMSPackage.GLOBAL_ENDPOINT_TYPE__GROUP);
		}
		return group;
	}
	...
	public FeatureMap getAbstractTransformerGroup() {
		return (FeatureMap)getGroup().<FeatureMap.Entry>list(JMSPackage.Literals.GLOBAL_ENDPOINT_TYPE__ABSTRACT_TRANSFORMER_GROUP);
	}
	...
	public EList<AbstractTransformerType> getAbstractTransformer() {
		return getAbstractTransformerGroup().list(JMSPackage.Literals.GLOBAL_ENDPOINT_TYPE__ABSTRACT_TRANSFORMER);
	}
	...
	public EList<TransformersType> getTransformers() {
		return getGroup().list(JMSPackage.Literals.GLOBAL_ENDPOINT_TYPE__TRANSFORMERS);
	}
	...
	public EList<ResponseTransformersType> getResponseTransformers() {
		return getGroup().list(JMSPackage.Literals.GLOBAL_ENDPOINT_TYPE__RESPONSE_TRANSFORMERS);
	}
	...
	public FeatureMap getAbstractTransactionGroup() {
		return (FeatureMap)getGroup().<FeatureMap.Entry>list(JMSPackage.Literals.GLOBAL_ENDPOINT_TYPE__ABSTRACT_TRANSACTION_GROUP);
	}
	...
	public EList<AbstractTransactionType> getAbstractTransaction() {
		return getAbstractTransactionGroup().list(JMSPackage.Literals.GLOBAL_ENDPOINT_TYPE__ABSTRACT_TRANSACTION);
	}
	...
	public FeatureMap getAbstractFilterGroup() {
		return (FeatureMap)getGroup().<FeatureMap.Entry>list(JMSPackage.Literals.GLOBAL_ENDPOINT_TYPE__ABSTRACT_FILTER_GROUP);
	}
	...
	public EList<AbstractFilterType> getAbstractFilter() {
		return getAbstractFilterGroup().list(JMSPackage.Literals.GLOBAL_ENDPOINT_TYPE__ABSTRACT_FILTER);
	}
	...
	public EList<JmsSelectorFilter> getSelector() {
		return getGroup().list(JMSPackage.Literals.GLOBAL_ENDPOINT_TYPE__SELECTOR);
	}
	...
	public FeatureMap getAbstractSecurityFilterGroup() {
		return (FeatureMap)getGroup().<FeatureMap.Entry>list(JMSPackage.Literals.GLOBAL_ENDPOINT_TYPE__ABSTRACT_SECURITY_FILTER_GROUP);
	}
	...
	public EList<AbstractSecurityFilterType> getAbstractSecurityFilter() {
		return getAbstractSecurityFilterGroup().list(JMSPackage.Literals.GLOBAL_ENDPOINT_TYPE__ABSTRACT_SECURITY_FILTER);
	}
	...
	public void setAddress(String newAddress) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, JMSPackage.GLOBAL_ENDPOINT_TYPE__ADDRESS, oldAddress, address));
	}
	...
	public void setConnectorRef(String newConnectorRef) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, JMSPackage.GLOBAL_ENDPOINT_TYPE__CONNECTOR_REF, oldConnectorRef, connectorRef));
	}
	...
	public void setEncoding(String newEncoding) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, JMSPackage.GLOBAL_ENDPOINT_TYPE__ENCODING, oldEncoding, encoding));
	}
	...
	public void setQueue(String newQueue) {
		...
		queue = newQueue;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, JMSPackage.GLOBAL_ENDPOINT_TYPE__QUEUE, oldQueue, queue));
	}
	...
	public void setRef(String newRef) {
		...
		ref = newRef;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, JMSPackage.GLOBAL_ENDPOINT_TYPE__REF, oldRef, ref));
	}
	...
	public void setRemoteSync(boolean newRemoteSync) {
		...
		remoteSyncESet = true;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, JMSPackage.GLOBAL_ENDPOINT_TYPE__REMOTE_SYNC, oldRemoteSync, remoteSync, !oldRemoteSyncESet));
	}
	...
	public void unsetRemoteSync() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, JMSPackage.GLOBAL_ENDPOINT_TYPE__REMOTE_SYNC, oldRemoteSync, REMOTE_SYNC_EDEFAULT, oldRemoteSyncESet));
	}
	...
	public void setRemoteSyncTimeout(int newRemoteSyncTimeout) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, JMSPackage.GLOBAL_ENDPOINT_TYPE__REMOTE_SYNC_TIMEOUT, oldRemoteSyncTimeout, remoteSyncTimeout, !oldRemoteSyncTimeoutESet));
	}
	...
	public void unsetRemoteSyncTimeout() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, JMSPackage.GLOBAL_ENDPOINT_TYPE__REMOTE_SYNC_TIMEOUT, oldRemoteSyncTimeout, REMOTE_SYNC_TIMEOUT_EDEFAULT, oldRemoteSyncTimeoutESet));
	}
	...
	public void setResponseTransformerRefs(List<String> newResponseTransformerRefs) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, JMSPackage.GLOBAL_ENDPOINT_TYPE__RESPONSE_TRANSFORMER_REFS, oldResponseTransformerRefs, responseTransformerRefs));
	}
	...
	public void setSynchronous(boolean newSynchronous) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, JMSPackage.GLOBAL_ENDPOINT_TYPE__SYNCHRONOUS, oldSynchronous, synchronous, !oldSynchronousESet));
	}
	...
	public void unsetSynchronous() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, JMSPackage.GLOBAL_ENDPOINT_TYPE__SYNCHRONOUS, oldSynchronous, SYNCHRONOUS_EDEFAULT, oldSynchronousESet));
	}
	...
	public void setTopic(String newTopic) {
		...
		topic = newTopic;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, JMSPackage.GLOBAL_ENDPOINT_TYPE__TOPIC, oldTopic, topic));
	}
	...
	public void setTransformerRefs(List<String> newTransformerRefs) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, JMSPackage.GLOBAL_ENDPOINT_TYPE__TRANSFORMER_REFS, oldTransformerRefs, transformerRefs));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			...
			case JMSPackage.GLOBAL_ENDPOINT_TYPE__ADDRESS:
				return getAddress();
			case JMSPackage.GLOBAL_ENDPOINT_TYPE__CONNECTOR_REF:
				return getConnectorRef();
			case JMSPackage.GLOBAL_ENDPOINT_TYPE__ENCODING:
				return getEncoding();
			case JMSPackage.GLOBAL_ENDPOINT_TYPE__QUEUE:
				return getQueue();
			case JMSPackage.GLOBAL_ENDPOINT_TYPE__REF:
				return getRef();
			case JMSPackage.GLOBAL_ENDPOINT_TYPE__REMOTE_SYNC:
				return isRemoteSync() ? Boolean.TRUE : Boolean.FALSE;
			case JMSPackage.GLOBAL_ENDPOINT_TYPE__REMOTE_SYNC_TIMEOUT:
				return new Integer(getRemoteSyncTimeout());
			case JMSPackage.GLOBAL_ENDPOINT_TYPE__RESPONSE_TRANSFORMER_REFS:
				return getResponseTransformerRefs();
			case JMSPackage.GLOBAL_ENDPOINT_TYPE__SYNCHRONOUS:
				return isSynchronous() ? Boolean.TRUE : Boolean.FALSE;
			case JMSPackage.GLOBAL_ENDPOINT_TYPE__TOPIC:
				return getTopic();
			case JMSPackage.GLOBAL_ENDPOINT_TYPE__TRANSFORMER_REFS:
