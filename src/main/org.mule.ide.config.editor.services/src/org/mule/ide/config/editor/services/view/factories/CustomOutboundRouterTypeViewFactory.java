 ...
 * @generated
 */
public class CustomOutboundRouterTypeViewFactory extends
	...
	protected void decorateView(View containerView, View view,
		...
		if (semanticHint == null) {
			semanticHint = CoreVisualIDRegistry
					.getType(CustomOutboundRouterTypeEditPart.VISUAL_ID);
		...
		getViewService()
				.createNode(
						...
						view,
						CoreVisualIDRegistry
								.getType(CustomOutboundRouterTypeClassEditPart.VISUAL_ID),
						ViewUtil.APPEND, true, getPreferencesHint());
		getViewService()
				.createNode(
						eObjectAdapter,
