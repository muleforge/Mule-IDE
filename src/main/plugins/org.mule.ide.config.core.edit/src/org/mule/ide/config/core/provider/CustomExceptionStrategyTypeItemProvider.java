...
public class CustomExceptionStrategyTypeItemProvider
	extends ExceptionStrategyTypeItemProvider
	implements	
	...
	public String getText(Object object) {
		String label = ((CustomExceptionStrategyType)object).getClass_();
		return label == null || label.length() == 0 ?
			getString("_UI_CustomExceptionStrategyType_type") :
			getString("_UI_CustomExceptionStrategyType_type") + " " + label;
	}
