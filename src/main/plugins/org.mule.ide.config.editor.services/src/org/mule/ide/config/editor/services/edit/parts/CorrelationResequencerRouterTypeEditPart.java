...
import org.mule.ide.config.editor.services.edit.policies.CorrelationResequencerRouterTypeItemSemanticEditPolicy;
...
public class CorrelationResequencerRouterTypeEditPart extends
	 ...
	 * @generated
	 */
	public CorrelationResequencerRouterTypeEditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new CorrelationResequencerRouterTypeItemSemanticEditPolicy());
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof CorrelationResequencerRouterTypeLabelEditPart) {
			((CorrelationResequencerRouterTypeLabelEditPart) childEditPart)
	...
	protected NodeFigure createNodeFigure() {
		...
		ServiceEditPartUtil.configureServiceItemFigure(figure,
				Messages.CorrelationResequencerRouterTypeLabel);
		return figure;
	}
