...
import org.mule.ide.config.editor.services.edit.policies.EndpointSelectorRouterTypeItemSemanticEditPolicy;
 ...
 * customization
 */
public class EndpointSelectorRouterTypeEditPart extends ServiceItemNodeEditPart {
	 ...
	 * @generated
	 */
	public EndpointSelectorRouterTypeEditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
							...
							if (request instanceof CreateViewAndElementRequest) {
								...
								if (type == CoreElementTypes.OutboundEndpointType_2030) {
									EditPart compartmentEditPart = getChildBySemanticHint(CoreVisualIDRegistry
											.getType(EndpointSelectorRouterTypeENDPOINTSEditPart.VISUAL_ID));
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new EndpointSelectorRouterTypeItemSemanticEditPolicy());
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof EndpointSelectorRouterTypeLabelEditPart) {
			((EndpointSelectorRouterTypeLabelEditPart) childEditPart)
	...
	protected NodeFigure createNodeFigure() {
		...
		ServiceEditPartUtil.configureServiceItemFigure(figure,
				Messages.EndpointSelectorOutboundRouterTypeLabel);
		return figure;
	}
