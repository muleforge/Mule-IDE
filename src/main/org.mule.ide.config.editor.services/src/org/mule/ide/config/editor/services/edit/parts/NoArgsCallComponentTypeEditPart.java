...
import org.mule.ide.config.editor.services.edit.policies.NoArgsCallComponentTypeItemSemanticEditPolicy;
 ...
 * @generated
 */
public class NoArgsCallComponentTypeEditPart extends ShapeNodeEditPart {
	 ...
	 * @generated
	 */
	public NoArgsCallComponentTypeEditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new NoArgsCallComponentTypeItemSemanticEditPolicy());
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof NoArgsCallComponentTypeLabelEditPart) {
			((NoArgsCallComponentTypeLabelEditPart) childEditPart)
					.setLabel(getPrimaryShape()
							.getFigureClassServiceItemTypeLabelFigure());
			return true;
		}
		if (childEditPart instanceof NoArgsCallComponentTypeClassEditPart) {
			((NoArgsCallComponentTypeClassEditPart) childEditPart)
					.setLabel(getPrimaryShape()
	...
	protected NodeFigure createNodeFigure() {
		...
		ServiceEditPartUtil.configureServiceItemFigure(figure,
				Messages.NoArgsCallComponentTypeLabel);
		return figure;
	}
