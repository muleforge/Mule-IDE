...
import org.mule.ide.config.editor.services.edit.policies.ChunkingInboundRouterTypeItemSemanticEditPolicy;
 ...
 * customization
 */
public class ChunkingInboundRouterTypeEditPart extends ServiceItemNodeEditPart {
	 ...
	 * @generated
	 */
	public ChunkingInboundRouterTypeEditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new ChunkingInboundRouterTypeItemSemanticEditPolicy());
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof ChunkingInboundRouterTypeLabelEditPart) {
			((ChunkingInboundRouterTypeLabelEditPart) childEditPart)
	...
	protected NodeFigure createNodeFigure() {
		...
		ServiceEditPartUtil.configureServiceItemFigure(figure,
				Messages.ChunkingInboundRouterTypeLabel);
		return figure;
	}
