...
public class InboundEndpointTypeImpl extends AbstractInboundEndpointTypeImpl implements InboundEndpointType {
	...
	public void setRemoteSyncTimeout(int newRemoteSyncTimeout) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, JMSPackage.INBOUND_ENDPOINT_TYPE__REMOTE_SYNC_TIMEOUT, oldRemoteSyncTimeout, remoteSyncTimeout, !oldRemoteSyncTimeoutESet));
	}
	...
	public void unsetRemoteSyncTimeout() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, JMSPackage.INBOUND_ENDPOINT_TYPE__REMOTE_SYNC_TIMEOUT, oldRemoteSyncTimeout, REMOTE_SYNC_TIMEOUT_EDEFAULT, oldRemoteSyncTimeoutESet));
	}
