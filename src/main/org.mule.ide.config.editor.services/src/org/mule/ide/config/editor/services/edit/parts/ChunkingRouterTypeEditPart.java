...
import org.mule.ide.config.editor.services.edit.policies.ChunkingRouterTypeItemSemanticEditPolicy;
...
public class ChunkingRouterTypeEditPart extends ShapeNodeEditPart {
	 ...
	 * @generated
	 */
	public ChunkingRouterTypeEditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new ChunkingRouterTypeItemSemanticEditPolicy());
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof ChunkingRouterTypeLabelEditPart) {
			((ChunkingRouterTypeLabelEditPart) childEditPart)
	...
	protected NodeFigure createNodeFigure() {
		...
		ServiceEditPartUtil.configureServiceItemFigure(figure,
				Messages.ChunkingRouterTypeLabel);
