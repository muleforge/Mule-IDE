 ...
 * <ul>
 *   <li>{@link org.mule.ide.config.core.impl.InboundEndpointTypeImpl#getGroup <em>Group</em>}</li>
 *   <li>{@link org.mule.ide.config.core.impl.InboundEndpointTypeImpl#getAbstractTransformerGroup <em>Abstract Transformer Group</em>}</li>
 *   <li>{@link org.mule.ide.config.core.impl.InboundEndpointTypeImpl#getAbstractTransformer <em>Abstract Transformer</em>}</li>
 *   <li>{@link org.mule.ide.config.core.impl.InboundEndpointTypeImpl#getTransformers <em>Transformers</em>}</li>
 *   <li>{@link org.mule.ide.config.core.impl.InboundEndpointTypeImpl#getResponseTransformers <em>Response Transformers</em>}</li>
 *   <li>{@link org.mule.ide.config.core.impl.InboundEndpointTypeImpl#getAbstractTransactionGroup <em>Abstract Transaction Group</em>}</li>
 *   <li>{@link org.mule.ide.config.core.impl.InboundEndpointTypeImpl#getAbstractTransaction <em>Abstract Transaction</em>}</li>
 *   <li>{@link org.mule.ide.config.core.impl.InboundEndpointTypeImpl#getAbstractFilterGroup <em>Abstract Filter Group</em>}</li>
 ...
 *   <li>{@link org.mule.ide.config.core.impl.InboundEndpointTypeImpl#getConnectorRef <em>Connector Ref</em>}</li>
 *   <li>{@link org.mule.ide.config.core.impl.InboundEndpointTypeImpl#getCreateConnector <em>Create Connector</em>}</li>
 *   <li>{@link org.mule.ide.config.core.impl.InboundEndpointTypeImpl#getEncoding <em>Encoding</em>}</li>
 *   <li>{@link org.mule.ide.config.core.impl.InboundEndpointTypeImpl#getRef <em>Ref</em>}</li>
 *   <li>{@link org.mule.ide.config.core.impl.InboundEndpointTypeImpl#isRemoteSync <em>Remote Sync</em>}</li>
 *   <li>{@link org.mule.ide.config.core.impl.InboundEndpointTypeImpl#getRemoteSyncTimeout <em>Remote Sync Timeout</em>}</li>
 *   <li>{@link org.mule.ide.config.core.impl.InboundEndpointTypeImpl#getResponseTransformerRefs <em>Response Transformer Refs</em>}</li>
 *   <li>{@link org.mule.ide.config.core.impl.InboundEndpointTypeImpl#isSynchronous <em>Synchronous</em>}</li>
 *   <li>{@link org.mule.ide.config.core.impl.InboundEndpointTypeImpl#getTransformerRefs <em>Transformer Refs</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class InboundEndpointTypeImpl extends AbstractInboundEndpointTypeImpl implements InboundEndpointType {
	...
	protected EClass eStaticClass() {
		return CorePackage.eINSTANCE.getInboundEndpointType();
	}
	...
	public FeatureMap getGroup() {
		if (group == null) {
			group = new BasicFeatureMap(this, CorePackage.INBOUND_ENDPOINT_TYPE__GROUP);
		}
		return group;
	}
	...
	public FeatureMap getAbstractTransformerGroup() {
		return (FeatureMap)getGroup().<FeatureMap.Entry>list(CorePackage.eINSTANCE.getInboundEndpointType_AbstractTransformerGroup());
	}
	...
	public EList<AbstractTransformerType> getAbstractTransformer() {
		return getAbstractTransformerGroup().list(CorePackage.eINSTANCE.getInboundEndpointType_AbstractTransformer());
	}
	...
	public EList<TransformersType> getTransformers() {
		return getGroup().list(CorePackage.eINSTANCE.getInboundEndpointType_Transformers());
	}
	...
	public EList<ResponseTransformersType> getResponseTransformers() {
		return getGroup().list(CorePackage.eINSTANCE.getInboundEndpointType_ResponseTransformers());
	}
	...
	public FeatureMap getAbstractTransactionGroup() {
		return (FeatureMap)getGroup().<FeatureMap.Entry>list(CorePackage.eINSTANCE.getInboundEndpointType_AbstractTransactionGroup());
	}
	...
	public EList<AbstractTransactionType> getAbstractTransaction() {
		return getAbstractTransactionGroup().list(CorePackage.eINSTANCE.getInboundEndpointType_AbstractTransaction());
	}
	...
	public FeatureMap getAbstractFilterGroup() {
		return (FeatureMap)getGroup().<FeatureMap.Entry>list(CorePackage.eINSTANCE.getInboundEndpointType_AbstractFilterGroup());
	}
	...
	public EList<AbstractFilterType> getAbstractFilter() {
		return getAbstractFilterGroup().list(CorePackage.eINSTANCE.getInboundEndpointType_AbstractFilter());
	}
	...
	public FeatureMap getAbstractSecurityFilterGroup() {
		return (FeatureMap)getGroup().<FeatureMap.Entry>list(CorePackage.eINSTANCE.getInboundEndpointType_AbstractSecurityFilterGroup());
	}
	...
	public EList<AbstractSecurityFilterType> getAbstractSecurityFilter() {
		return getAbstractSecurityFilterGroup().list(CorePackage.eINSTANCE.getInboundEndpointType_AbstractSecurityFilter());
	}
	...
	public EList<MapType> getProperties() {
		return getGroup().list(CorePackage.eINSTANCE.getInboundEndpointType_Properties());
	}
	...
	public void setAddress(String newAddress) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CorePackage.INBOUND_ENDPOINT_TYPE__ADDRESS, oldAddress, address));
	}
	...
	public void setConnectorRef(String newConnectorRef) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CorePackage.INBOUND_ENDPOINT_TYPE__CONNECTOR_REF, oldConnectorRef, connectorRef));
	}
	...
	public void setCreateConnector(CreateConnectorType newCreateConnector) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CorePackage.INBOUND_ENDPOINT_TYPE__CREATE_CONNECTOR, oldCreateConnector, createConnector, !oldCreateConnectorESet));
	}
	...
	public void unsetCreateConnector() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, CorePackage.INBOUND_ENDPOINT_TYPE__CREATE_CONNECTOR, oldCreateConnector, CREATE_CONNECTOR_EDEFAULT, oldCreateConnectorESet));
	}
	...
	public void setEncoding(String newEncoding) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CorePackage.INBOUND_ENDPOINT_TYPE__ENCODING, oldEncoding, encoding));
	}
	...
	public void setRef(String newRef) {
		...
		ref = newRef;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CorePackage.INBOUND_ENDPOINT_TYPE__REF, oldRef, ref));
	}
	...
	public void setRemoteSync(boolean newRemoteSync) {
		...
		remoteSyncESet = true;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CorePackage.INBOUND_ENDPOINT_TYPE__REMOTE_SYNC, oldRemoteSync, remoteSync, !oldRemoteSyncESet));
	}
	...
	public void unsetRemoteSync() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, CorePackage.INBOUND_ENDPOINT_TYPE__REMOTE_SYNC, oldRemoteSync, REMOTE_SYNC_EDEFAULT, oldRemoteSyncESet));
	}
	...
	public void setRemoteSyncTimeout(String newRemoteSyncTimeout) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CorePackage.INBOUND_ENDPOINT_TYPE__REMOTE_SYNC_TIMEOUT, oldRemoteSyncTimeout, remoteSyncTimeout));
	}
	...
	public void setResponseTransformerRefs(List<String> newResponseTransformerRefs) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CorePackage.INBOUND_ENDPOINT_TYPE__RESPONSE_TRANSFORMER_REFS, oldResponseTransformerRefs, responseTransformerRefs));
	}
	...
	public void setSynchronous(boolean newSynchronous) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CorePackage.INBOUND_ENDPOINT_TYPE__SYNCHRONOUS, oldSynchronous, synchronous, !oldSynchronousESet));
	}
	...
	public void unsetSynchronous() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, CorePackage.INBOUND_ENDPOINT_TYPE__SYNCHRONOUS, oldSynchronous, SYNCHRONOUS_EDEFAULT, oldSynchronousESet));
	}
	...
	public void setTransformerRefs(List<String> newTransformerRefs) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CorePackage.INBOUND_ENDPOINT_TYPE__TRANSFORMER_REFS, oldTransformerRefs, transformerRefs));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case CorePackage.INBOUND_ENDPOINT_TYPE__GROUP:
				return ((InternalEList<?>)getGroup()).basicRemove(otherEnd, msgs);
			case CorePackage.INBOUND_ENDPOINT_TYPE__ABSTRACT_TRANSFORMER_GROUP:
				return ((InternalEList<?>)getAbstractTransformerGroup()).basicRemove(otherEnd, msgs);
			case CorePackage.INBOUND_ENDPOINT_TYPE__ABSTRACT_TRANSFORMER:
				return ((InternalEList<?>)getAbstractTransformer()).basicRemove(otherEnd, msgs);
			case CorePackage.INBOUND_ENDPOINT_TYPE__TRANSFORMERS:
				return ((InternalEList<?>)getTransformers()).basicRemove(otherEnd, msgs);
			case CorePackage.INBOUND_ENDPOINT_TYPE__RESPONSE_TRANSFORMERS:
				return ((InternalEList<?>)getResponseTransformers()).basicRemove(otherEnd, msgs);
			case CorePackage.INBOUND_ENDPOINT_TYPE__ABSTRACT_TRANSACTION_GROUP:
				return ((InternalEList<?>)getAbstractTransactionGroup()).basicRemove(otherEnd, msgs);
			case CorePackage.INBOUND_ENDPOINT_TYPE__ABSTRACT_TRANSACTION:
				return ((InternalEList<?>)getAbstractTransaction()).basicRemove(otherEnd, msgs);
			case CorePackage.INBOUND_ENDPOINT_TYPE__ABSTRACT_FILTER_GROUP:
				return ((InternalEList<?>)getAbstractFilterGroup()).basicRemove(otherEnd, msgs);
			case CorePackage.INBOUND_ENDPOINT_TYPE__ABSTRACT_FILTER:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			...
			case CorePackage.INBOUND_ENDPOINT_TYPE__REMOTE_SYNC_TIMEOUT:
				return getRemoteSyncTimeout();
			case CorePackage.INBOUND_ENDPOINT_TYPE__RESPONSE_TRANSFORMER_REFS:
				return getResponseTransformerRefs();
			case CorePackage.INBOUND_ENDPOINT_TYPE__SYNCHRONOUS:
				return isSynchronous() ? Boolean.TRUE : Boolean.FALSE;
			case CorePackage.INBOUND_ENDPOINT_TYPE__TRANSFORMER_REFS:
