...
import org.mule.ide.config.editor.services.edit.policies.CustomInboundRouterTypeItemSemanticEditPolicy;
 ...
 * customization
 */
public class CustomInboundRouterTypeEditPart extends ServiceItemNodeEditPart {
	 ...
	 * @generated
	 */
	public CustomInboundRouterTypeEditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new CustomInboundRouterTypeItemSemanticEditPolicy());
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof CustomInboundRouterTypeLabelEditPart) {
			((CustomInboundRouterTypeLabelEditPart) childEditPart)
					.setLabel(getPrimaryShape()
							.getFigureClassServiceItemTypeLabelFigure());
			return true;
		}
		if (childEditPart instanceof CustomInboundRouterTypeClassEditPart) {
			((CustomInboundRouterTypeClassEditPart) childEditPart)
					.setLabel(getPrimaryShape()
	...
	protected NodeFigure createNodeFigure() {
		...
		ServiceEditPartUtil.configureServiceItemFigure(figure,
				Messages.CustomInboundRouterTypeLabel);
		return figure;
	}
