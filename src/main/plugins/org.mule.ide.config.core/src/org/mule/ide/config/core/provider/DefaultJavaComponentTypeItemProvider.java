...
/**
 * This is the item provider adapter for a {@link org.mule.ide.config.core.DefaultJavaComponentType} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class DefaultJavaComponentTypeItemProvider
	 ...
	 * @generated
	 */
	public DefaultJavaComponentTypeItemProvider(AdapterFactory adapterFactory) {
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_DefaultJavaComponentType_class_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_DefaultJavaComponentType_class_feature", "_UI_DefaultJavaComponentType_type"),
				 CorePackage.eINSTANCE.getDefaultJavaComponentType_Class(),
				 true,
				 false,
				 false,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(CorePackage.eINSTANCE.getDefaultJavaComponentType_AbstractObjectFactoryGroup());
			childrenFeatures.add(CorePackage.eINSTANCE.getDefaultJavaComponentType_AbstractLifecycleAdapterFactoryGroup());
			childrenFeatures.add(CorePackage.eINSTANCE.getDefaultJavaComponentType_Binding());
		}
	...
	public String getText(Object object) {
		String label = ((DefaultJavaComponentType)object).getClass_();
		return label == null || label.length() == 0 ?
			getString("_UI_DefaultJavaComponentType_type") :
			getString("_UI_DefaultJavaComponentType_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(DefaultJavaComponentType.class)) {
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(CorePackage.eINSTANCE.getDefaultJavaComponentType_AbstractObjectFactoryGroup(),
		...
		newChildDescriptors.add
			(createChildParameter
				(CorePackage.eINSTANCE.getDefaultJavaComponentType_AbstractLifecycleAdapterFactoryGroup(),
				 FeatureMapUtil.createEntry
					(CorePackage.eINSTANCE.getDocumentRoot_CustomLifecycleAdapterFactory(),
					 CoreFactory.eINSTANCE.createCustomLifecycleAdapterFactory())));

		newChildDescriptors.add
			(createChildParameter
				(CorePackage.eINSTANCE.getDefaultJavaComponentType_Binding(),
