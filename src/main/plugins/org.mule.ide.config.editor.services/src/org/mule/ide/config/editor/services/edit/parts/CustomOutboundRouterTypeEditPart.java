...
import org.mule.ide.config.editor.services.edit.policies.CustomOutboundRouterTypeItemSemanticEditPolicy;
 ...
 * customization
 */
public class CustomOutboundRouterTypeEditPart extends ServiceItemNodeEditPart {
	 ...
	 * @generated
	 */
	public CustomOutboundRouterTypeEditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new CustomOutboundRouterTypeItemSemanticEditPolicy());
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof CustomOutboundRouterTypeLabelEditPart) {
			((CustomOutboundRouterTypeLabelEditPart) childEditPart)
					.setLabel(getPrimaryShape()
							.getFigureClassServiceItemTypeLabelFigure());
			return true;
		}
		if (childEditPart instanceof CustomOutboundRouterTypeClassEditPart) {
			((CustomOutboundRouterTypeClassEditPart) childEditPart)
					.setLabel(getPrimaryShape()
	...
	protected NodeFigure createNodeFigure() {
		...
		ServiceEditPartUtil.configureServiceItemFigure(figure,
				Messages.CustomOutboundRouterTypeLabel);
		return figure;
	}
