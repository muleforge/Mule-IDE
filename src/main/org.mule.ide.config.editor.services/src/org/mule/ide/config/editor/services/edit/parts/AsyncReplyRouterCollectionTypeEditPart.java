...
import org.mule.ide.config.editor.services.edit.policies.AsyncReplyRouterCollectionTypeItemSemanticEditPolicy;
 ...
 * @generated
 */
public class AsyncReplyRouterCollectionTypeEditPart extends ShapeNodeEditPart {
	 ...
	 * @generated
	 */
	public AsyncReplyRouterCollectionTypeEditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
							...
							if (request instanceof CreateViewAndElementRequest) {
								...
								if (type == CoreElementTypes.InboundEndpointType_2026) {
									EditPart compartmentEditPart = getChildBySemanticHint(CoreVisualIDRegistry
											.getType(AsyncReplyRouterCollectionTypeINBOUNDENDPOINTSEditPart.VISUAL_ID));
								...
								if (type == CoreElementTypes.AsyncReplyRouterType_2027) {
									EditPart compartmentEditPart = getChildBySemanticHint(CoreVisualIDRegistry
											.getType(AsyncReplyRouterCollectionTypeASYNCREPLYROUTERSEditPart.VISUAL_ID));
									return compartmentEditPart == null ? null
											: compartmentEditPart
													.getCommand(request);
								}
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new AsyncReplyRouterCollectionTypeItemSemanticEditPolicy());
