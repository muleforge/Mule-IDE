package org.mule.ide.config.jms.editor.services.edit.parts;
...
import org.mule.ide.config.editor.services.edit.parts.ReadOnlyLabelCompartmentEditPart;
import org.mule.ide.config.jms.editor.services.edit.policies.JMSTextSelectionEditPolicy;
...
public class InboundEndpointServiceItemTypeLabelEditPart extends
	...
	protected Image getLabelIcon() {
		...
		return JMSElementTypes.getImage(parserElement.eClass());
	}
	...
	public void setLabelText(String text) {
		...
		if (pdEditPolicy instanceof JMSTextSelectionEditPolicy) {
			((JMSTextSelectionEditPolicy) pdEditPolicy).refreshFeedback();
		}
	}
	...
	protected DirectEditManager getManager() {
		if (manager == null) {
			setManager(new TextDirectEditManager(this, TextDirectEditManager
					.getTextCellEditorClass(this), JMSEditPartFactory
