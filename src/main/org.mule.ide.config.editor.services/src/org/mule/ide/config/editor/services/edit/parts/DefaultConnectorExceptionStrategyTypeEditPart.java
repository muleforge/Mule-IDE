 ...
 * @generated
 */
public class DefaultConnectorExceptionStrategyTypeEditPart extends
		ShapeNodeEditPart {
	 ...
	 * @generated
	 */
	public DefaultConnectorExceptionStrategyTypeEditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(
				...
				new DefaultConnectorExceptionStrategyTypeItemSemanticEditPolicy());
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof DefaultConnectorExceptionStrategyTypeLabelEditPart) {
			((DefaultConnectorExceptionStrategyTypeLabelEditPart) childEditPart)
	...
	protected NodeFigure createNodeFigure() {
		...
		ServiceEditPartUtil.configureServiceItemFigure(figure,
				Messages.DefaultConnectorExceptionStrategyTypeLabel);
		return figure;
	}
