 ...
 * @generated
 */
public class VMDiagramEditorPlugin extends AbstractUIPlugin {

	/**
	 * @generated
	 */
	public static final String ID = "org.mule.ide.config.vm.editor.services"; //$NON-NLS-1$
	 ...
	 * @generated
	 */
	private static VMDiagramEditorPlugin instance;
	 ...
	 * @generated
	 */
	private VMDocumentProvider documentProvider;

	/**
	 * @generated
	 */
	public VMDiagramEditorPlugin() {
	}
	 ...
	 * @generated
	 */
	public static VMDiagramEditorPlugin getInstance() {
		return instance;
	}
	...
	protected void fillItemProviderFactories(List factories) {
		factories.add(new VMItemProviderAdapterFactory());
	 ...
	 * @generated
	 */
	public VMDocumentProvider getDocumentProvider() {
		if (documentProvider == null) {
			documentProvider = new VMDocumentProvider();
		}
	...
	public void logError(String error, Throwable throwable) {
		...
		getLog().log(
				new Status(IStatus.ERROR, VMDiagramEditorPlugin.ID, IStatus.OK,
						error, throwable));
	...
	public void logInfo(String message, Throwable throwable) {
		...
		getLog().log(
				new Status(IStatus.INFO, VMDiagramEditorPlugin.ID, IStatus.OK,
						message, throwable));
