...
/**
 * This is the item provider adapter for a {@link org.mule.ide.config.core.CustomServiceType} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class CustomServiceTypeItemProvider
	 ...
	 * @generated
	 */
	public CustomServiceTypeItemProvider(AdapterFactory adapterFactory) {
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_CustomServiceType_class_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_CustomServiceType_class_feature", "_UI_CustomServiceType_type"),
				 CorePackage.eINSTANCE.getCustomServiceType_Class(),
				 true,
				 false,
				 false,
	...
	public String getText(Object object) {
		String label = ((CustomServiceType)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_CustomServiceType_type") :
			getString("_UI_CustomServiceType_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(CustomServiceType.class)) {
			case CorePackage.CUSTOM_SERVICE_TYPE__CLASS:
