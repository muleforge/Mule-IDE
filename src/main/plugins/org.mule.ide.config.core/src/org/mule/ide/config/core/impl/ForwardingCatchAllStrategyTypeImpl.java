...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Forwarding Catch All Strategy Type</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * <ul>
 *   <li>{@link org.mule.ide.config.core.impl.ForwardingCatchAllStrategyTypeImpl#getAbstractOutboundEndpointGroup <em>Abstract Outbound Endpoint Group</em>}</li>
 *   <li>{@link org.mule.ide.config.core.impl.ForwardingCatchAllStrategyTypeImpl#getAbstractOutboundEndpoint <em>Abstract Outbound Endpoint</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class ForwardingCatchAllStrategyTypeImpl extends AbstractCatchAllStrategyTypeImpl implements ForwardingCatchAllStrategyType {
	/**
	 ...
	 * @generated
	 */
	protected ForwardingCatchAllStrategyTypeImpl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return CorePackage.eINSTANCE.getForwardingCatchAllStrategyType();
	}
	...
	public FeatureMap getAbstractOutboundEndpointGroup() {
		if (abstractOutboundEndpointGroup == null) {
			abstractOutboundEndpointGroup = new BasicFeatureMap(this, CorePackage.FORWARDING_CATCH_ALL_STRATEGY_TYPE__ABSTRACT_OUTBOUND_ENDPOINT_GROUP);
		}
	...
	public EList<AbstractOutboundEndpointType> getAbstractOutboundEndpoint() {
		return getAbstractOutboundEndpointGroup().list(CorePackage.eINSTANCE.getForwardingCatchAllStrategyType_AbstractOutboundEndpoint());
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case CorePackage.FORWARDING_CATCH_ALL_STRATEGY_TYPE__ABSTRACT_OUTBOUND_ENDPOINT_GROUP:
				return ((InternalEList<?>)getAbstractOutboundEndpointGroup()).basicRemove(otherEnd, msgs);
			case CorePackage.FORWARDING_CATCH_ALL_STRATEGY_TYPE__ABSTRACT_OUTBOUND_ENDPOINT:
...
} //ForwardingCatchAllStrategyTypeImpl
