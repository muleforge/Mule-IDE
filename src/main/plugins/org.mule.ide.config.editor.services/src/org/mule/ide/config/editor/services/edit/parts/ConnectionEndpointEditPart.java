 ...
 * @generated
 */
public class ConnectionEndpointEditPart extends LabelEditPart implements
		ITextAwareEditPart {
	...
	static {
		registerSnapBackPosition(
				CoreVisualIDRegistry
						.getType(org.mule.ide.config.editor.services.edit.parts.ConnectionEndpointEditPart.VISUAL_ID),
				new Point(0, 40));
	}
	 ...
	 * @generated
	 */
	public ConnectionEndpointEditPart(View view) {
		super(view);
	}
	...
	public void setLabelText(String text) {
		...
		if (pdEditPolicy instanceof CoreTextSelectionEditPolicy) {
			((CoreTextSelectionEditPolicy) pdEditPolicy).refreshFeedback();
		}
	}
	...
	public IParser getParser() {
		if (parser == null) {
			...
			IAdaptable hintAdapter = new CoreParserProvider.HintAdapter(
					CoreElementTypes.Connection_3001, getParserElement(),
					parserHint);
	...
	protected DirectEditManager getManager() {
		if (manager == null) {
			setManager(new TextDirectEditManager(this, TextDirectEditManager
					.getTextCellEditorClass(this), CoreEditPartFactory
