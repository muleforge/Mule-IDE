 ...
 *   <li>{@link org.mule.ide.config.core.impl.GlobalEndpointTypeImpl#getAbstractFilter <em>Abstract Filter</em>}</li>
 *   <li>{@link org.mule.ide.config.core.impl.GlobalEndpointTypeImpl#getAbstractSecurityFilterGroup <em>Abstract Security Filter Group</em>}</li>
 ...
 *   <li>{@link org.mule.ide.config.core.impl.GlobalEndpointTypeImpl#getRemoteSyncTimeout <em>Remote Sync Timeout</em>}</li>
 *   <li>{@link org.mule.ide.config.core.impl.GlobalEndpointTypeImpl#getResponseTransformerRefs <em>Response Transformer Refs</em>}</li>
 *   <li>{@link org.mule.ide.config.core.impl.GlobalEndpointTypeImpl#isSynchronous <em>Synchronous</em>}</li>
 *   <li>{@link org.mule.ide.config.core.impl.GlobalEndpointTypeImpl#getTransformerRefs <em>Transformer Refs</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class GlobalEndpointTypeImpl extends AbstractGlobalEndpointTypeImpl implements GlobalEndpointType {
	...
	protected EClass eStaticClass() {
		return CorePackage.eINSTANCE.getGlobalEndpointType();
	}
	...
	public FeatureMap getGroup() {
		if (group == null) {
			group = new BasicFeatureMap(this, CorePackage.GLOBAL_ENDPOINT_TYPE__GROUP);
		}
		return group;
	}
	...
	public FeatureMap getAbstractTransformerGroup() {
		return (FeatureMap)getGroup().<FeatureMap.Entry>list(CorePackage.eINSTANCE.getGlobalEndpointType_AbstractTransformerGroup());
	}
	...
	public FeatureMap getAbstractTransactionGroup() {
		return (FeatureMap)getGroup().<FeatureMap.Entry>list(CorePackage.eINSTANCE.getGlobalEndpointType_AbstractTransactionGroup());
	}
	...
	public EList<AbstractTransactionType> getAbstractTransaction() {
		return getAbstractTransactionGroup().list(CorePackage.eINSTANCE.getGlobalEndpointType_AbstractTransaction());
	}
	...
	public FeatureMap getAbstractFilterGroup() {
		return (FeatureMap)getGroup().<FeatureMap.Entry>list(CorePackage.eINSTANCE.getGlobalEndpointType_AbstractFilterGroup());
	}
	...
	public EList<AbstractFilterType> getAbstractFilter() {
		return getAbstractFilterGroup().list(CorePackage.eINSTANCE.getGlobalEndpointType_AbstractFilter());
	}
	...
	public FeatureMap getAbstractSecurityFilterGroup() {
		return (FeatureMap)getGroup().<FeatureMap.Entry>list(CorePackage.eINSTANCE.getGlobalEndpointType_AbstractSecurityFilterGroup());
	}
	...
	public EList<AbstractSecurityFilterType> getAbstractSecurityFilter() {
		return getAbstractSecurityFilterGroup().list(CorePackage.eINSTANCE.getGlobalEndpointType_AbstractSecurityFilter());
	}
	...
	public FeatureMap getAbstractConnectionStrategyGroup() {
		return (FeatureMap)getGroup().<FeatureMap.Entry>list(CorePackage.eINSTANCE.getGlobalEndpointType_AbstractConnectionStrategyGroup());
	}
	...
	public EList<AbstractConnectionStrategyType> getAbstractConnectionStrategy() {
		return getAbstractConnectionStrategyGroup().list(CorePackage.eINSTANCE.getGlobalEndpointType_AbstractConnectionStrategy());
	}
	...
	public void setAddress(String newAddress) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CorePackage.GLOBAL_ENDPOINT_TYPE__ADDRESS, oldAddress, address));
	}
	...
	public void setConnectorRef(String newConnectorRef) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CorePackage.GLOBAL_ENDPOINT_TYPE__CONNECTOR_REF, oldConnectorRef, connectorRef));
	}
	...
	public void setEncoding(String newEncoding) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CorePackage.GLOBAL_ENDPOINT_TYPE__ENCODING, oldEncoding, encoding));
	}
	...
	public void setRef(String newRef) {
		...
		ref = newRef;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CorePackage.GLOBAL_ENDPOINT_TYPE__REF, oldRef, ref));
	}
	...
	public void setRemoteSync(boolean newRemoteSync) {
		...
		remoteSyncESet = true;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CorePackage.GLOBAL_ENDPOINT_TYPE__REMOTE_SYNC, oldRemoteSync, remoteSync, !oldRemoteSyncESet));
	}
	...
	public void unsetRemoteSync() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, CorePackage.GLOBAL_ENDPOINT_TYPE__REMOTE_SYNC, oldRemoteSync, REMOTE_SYNC_EDEFAULT, oldRemoteSyncESet));
	}
	...
	public void setRemoteSyncTimeout(int newRemoteSyncTimeout) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CorePackage.GLOBAL_ENDPOINT_TYPE__REMOTE_SYNC_TIMEOUT, oldRemoteSyncTimeout, remoteSyncTimeout, !oldRemoteSyncTimeoutESet));
	}
	...
	public void unsetRemoteSyncTimeout() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, CorePackage.GLOBAL_ENDPOINT_TYPE__REMOTE_SYNC_TIMEOUT, oldRemoteSyncTimeout, REMOTE_SYNC_TIMEOUT_EDEFAULT, oldRemoteSyncTimeoutESet));
	}
	...
	public void setResponseTransformerRefs(List<String> newResponseTransformerRefs) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CorePackage.GLOBAL_ENDPOINT_TYPE__RESPONSE_TRANSFORMER_REFS, oldResponseTransformerRefs, responseTransformerRefs));
	}
	...
	public void setSynchronous(boolean newSynchronous) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CorePackage.GLOBAL_ENDPOINT_TYPE__SYNCHRONOUS, oldSynchronous, synchronous, !oldSynchronousESet));
	}
	...
	public void unsetSynchronous() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, CorePackage.GLOBAL_ENDPOINT_TYPE__SYNCHRONOUS, oldSynchronous, SYNCHRONOUS_EDEFAULT, oldSynchronousESet));
	}
	...
	public void setTransformerRefs(List<String> newTransformerRefs) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CorePackage.GLOBAL_ENDPOINT_TYPE__TRANSFORMER_REFS, oldTransformerRefs, transformerRefs));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			...
			case CorePackage.GLOBAL_ENDPOINT_TYPE__ABSTRACT_FILTER_GROUP:
				return ((InternalEList<?>)getAbstractFilterGroup()).basicRemove(otherEnd, msgs);
			case CorePackage.GLOBAL_ENDPOINT_TYPE__ABSTRACT_FILTER:
				return ((InternalEList<?>)getAbstractFilter()).basicRemove(otherEnd, msgs);
			case CorePackage.GLOBAL_ENDPOINT_TYPE__ABSTRACT_SECURITY_FILTER_GROUP:
				return ((InternalEList<?>)getAbstractSecurityFilterGroup()).basicRemove(otherEnd, msgs);
			case CorePackage.GLOBAL_ENDPOINT_TYPE__ABSTRACT_SECURITY_FILTER:
