 ...
 * <ul>
 *   <li>{@link org.mule.ide.config.core.impl.KeyValueTypeImpl#getValue <em>Value</em>}</li>
 *   <li>{@link org.mule.ide.config.core.impl.KeyValueTypeImpl#getValueRef <em>Value Ref</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class KeyValueTypeImpl extends KeyTypeImpl implements KeyValueType {
	/**
	...
	protected EClass eStaticClass() {
		return CorePackage.eINSTANCE.getKeyValueType();
	}
	...
	public void setValue(String newValue) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CorePackage.KEY_VALUE_TYPE__VALUE, oldValue, value));
	}
	...
	public void setValueRef(String newValueRef) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CorePackage.KEY_VALUE_TYPE__VALUE_REF, oldValueRef, valueRef));
	}
