...
import org.mule.ide.config.jms.editor.services.edit.helpers.JMSBaseEditHelper;
import org.mule.ide.config.jms.editor.services.part.JMSVisualIDRegistry;

/**
 * @generated
 */
public class JMSBaseItemSemanticEditPolicy extends SemanticEditPolicy {
	...
	public Command getCommand(Request request) {
		if (request instanceof ReconnectRequest) {
			...
			if (view instanceof View) {
				Integer id = new Integer(JMSVisualIDRegistry
	...
	protected Command getSemanticCommand(IEditCommandRequest request) {
		...
		if (semanticCommand != null) {
			...
			completedRequest.setParameter(
					JMSBaseEditHelper.EDIT_POLICY_COMMAND, command);
		}
		if (elementType != null) {
