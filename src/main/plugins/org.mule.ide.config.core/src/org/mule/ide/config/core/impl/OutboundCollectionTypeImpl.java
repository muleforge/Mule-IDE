...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Outbound Collection Type</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * <ul>
 *   <li>{@link org.mule.ide.config.core.impl.OutboundCollectionTypeImpl#getAbstractCatchAllStrategyGroup <em>Abstract Catch All Strategy Group</em>}</li>
 *   <li>{@link org.mule.ide.config.core.impl.OutboundCollectionTypeImpl#getAbstractCatchAllStrategy <em>Abstract Catch All Strategy</em>}</li>
 *   <li>{@link org.mule.ide.config.core.impl.OutboundCollectionTypeImpl#getAbstractOutboundRouterGroup <em>Abstract Outbound Router Group</em>}</li>
 *   <li>{@link org.mule.ide.config.core.impl.OutboundCollectionTypeImpl#getAbstractOutboundRouter <em>Abstract Outbound Router</em>}</li>
 *   <li>{@link org.mule.ide.config.core.impl.OutboundCollectionTypeImpl#isMatchAll <em>Match All</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class OutboundCollectionTypeImpl extends PlaceholderSupportEObjectImpl implements OutboundCollectionType {
	/**
	 ...
	 * @generated
	 */
	protected OutboundCollectionTypeImpl() {
		super();
	}
	...
	public FeatureMap getAbstractCatchAllStrategyGroup() {
		if (abstractCatchAllStrategyGroup == null) {
			abstractCatchAllStrategyGroup = new BasicFeatureMap(this, CorePackage.OUTBOUND_COLLECTION_TYPE__ABSTRACT_CATCH_ALL_STRATEGY_GROUP);
		}
	...
	public AbstractCatchAllStrategyType getAbstractCatchAllStrategy() {
		return (AbstractCatchAllStrategyType)getAbstractCatchAllStrategyGroup().get(CorePackage.eINSTANCE.getOutboundCollectionType_AbstractCatchAllStrategy(), true);
	}
	...
	public NotificationChain basicSetAbstractCatchAllStrategy(AbstractCatchAllStrategyType newAbstractCatchAllStrategy, NotificationChain msgs) {
		return ((FeatureMap.Internal)getAbstractCatchAllStrategyGroup()).basicAdd(CorePackage.eINSTANCE.getOutboundCollectionType_AbstractCatchAllStrategy(), newAbstractCatchAllStrategy, msgs);
	}
	...
	public FeatureMap getAbstractOutboundRouterGroup() {
		if (abstractOutboundRouterGroup == null) {
			abstractOutboundRouterGroup = new BasicFeatureMap(this, CorePackage.OUTBOUND_COLLECTION_TYPE__ABSTRACT_OUTBOUND_ROUTER_GROUP);
		}
	...
	public EList<AbstractOutboundRouterType> getAbstractOutboundRouter() {
		return getAbstractOutboundRouterGroup().list(CorePackage.eINSTANCE.getOutboundCollectionType_AbstractOutboundRouter());
	}
	...
	public void setMatchAll(boolean newMatchAll) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CorePackage.OUTBOUND_COLLECTION_TYPE__MATCH_ALL, oldMatchAll, matchAll, !oldMatchAllESet));
	}
	...
	public void unsetMatchAll() {
		...
		matchAllESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, CorePackage.OUTBOUND_COLLECTION_TYPE__MATCH_ALL, oldMatchAll, MATCH_ALL_EDEFAULT, oldMatchAllESet));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			...
			case CorePackage.OUTBOUND_COLLECTION_TYPE__ABSTRACT_CATCH_ALL_STRATEGY:
			...
			case CorePackage.OUTBOUND_COLLECTION_TYPE__ABSTRACT_OUTBOUND_ROUTER:
