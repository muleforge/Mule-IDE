...
public class MuleDistributionClasspathInitializer extends ClasspathContainerInitializer {
	...
	public void initialize(final IPath path, final IJavaProject project) throws CoreException {
		...
		final IMuleDistribution distrib = 
			MuleDistributionFactory.getInstance().createMuleDistribution(new File(candidate));
		...
		IClasspathContainer container = new IClasspathContainer() {
			...
			public String getDescription() {
				return "Mule Libraries ["+ distrib.getLocation().getName()+"]";
			}
			public int getKind() {
