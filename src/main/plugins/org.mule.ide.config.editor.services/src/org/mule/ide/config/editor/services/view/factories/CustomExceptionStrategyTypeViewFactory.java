 ...
 * @generated
 */
public class CustomExceptionStrategyTypeViewFactory extends
	...
	protected void decorateView(View containerView, View view,
		...
		if (semanticHint == null) {
			semanticHint = CoreVisualIDRegistry
					.getType(CustomExceptionStrategyTypeEditPart.VISUAL_ID);
		...
		getViewService()
				.createNode(
						...
						view,
						CoreVisualIDRegistry
								.getType(CustomExceptionStrategyTypeClassEditPart.VISUAL_ID),
						ViewUtil.APPEND, true, getPreferencesHint());
		getViewService()
				.createNode(
						eObjectAdapter,
