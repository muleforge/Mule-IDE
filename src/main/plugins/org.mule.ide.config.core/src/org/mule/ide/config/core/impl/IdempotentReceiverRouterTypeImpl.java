...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Idempotent Receiver Router Type</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * <ul>
 *   <li>{@link org.mule.ide.config.core.impl.IdempotentReceiverRouterTypeImpl#getAbstractStorageGroup <em>Abstract Storage Group</em>}</li>
 *   <li>{@link org.mule.ide.config.core.impl.IdempotentReceiverRouterTypeImpl#getAbstractStorage <em>Abstract Storage</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class IdempotentReceiverRouterTypeImpl extends FilteredInboundRouterTypeImpl implements IdempotentReceiverRouterType {
	/**
	 ...
	 * @generated
	 */
	protected IdempotentReceiverRouterTypeImpl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return CorePackage.eINSTANCE.getIdempotentReceiverRouterType();
	}
	...
	public FeatureMap getAbstractStorageGroup() {
		if (abstractStorageGroup == null) {
			abstractStorageGroup = new BasicFeatureMap(this, CorePackage.IDEMPOTENT_RECEIVER_ROUTER_TYPE__ABSTRACT_STORAGE_GROUP);
		}
	...
	public AbstractStorageType getAbstractStorage() {
		return (AbstractStorageType)getAbstractStorageGroup().get(CorePackage.eINSTANCE.getIdempotentReceiverRouterType_AbstractStorage(), true);
	}
	...
	public NotificationChain basicSetAbstractStorage(AbstractStorageType newAbstractStorage, NotificationChain msgs) {
		return ((FeatureMap.Internal)getAbstractStorageGroup()).basicAdd(CorePackage.eINSTANCE.getIdempotentReceiverRouterType_AbstractStorage(), newAbstractStorage, msgs);
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			...
			case CorePackage.IDEMPOTENT_RECEIVER_ROUTER_TYPE__ABSTRACT_STORAGE:
...
} //IdempotentReceiverRouterTypeImpl
