...
import org.mule.ide.config.editor.services.edit.policies.PassThroughOutboundRouterTypeItemSemanticEditPolicy;
 ...
 * @generated
 */
public class PassThroughOutboundRouterTypeEditPart extends ShapeNodeEditPart {
	 ...
	 * @generated
	 */
	public PassThroughOutboundRouterTypeEditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
							...
							if (request instanceof CreateViewAndElementRequest) {
								...
								if (type == CoreElementTypes.OutboundEndpointType_2031) {
									EditPart compartmentEditPart = getChildBySemanticHint(CoreVisualIDRegistry
											.getType(PassThroughOutboundRouterTypeENDPOINTSEditPart.VISUAL_ID));
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new PassThroughOutboundRouterTypeItemSemanticEditPolicy());
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof PassThroughOutboundRouterTypeLabelEditPart) {
			((PassThroughOutboundRouterTypeLabelEditPart) childEditPart)
	...
	protected NodeFigure createNodeFigure() {
		...
		ServiceEditPartUtil.configureServiceItemFigure(figure,
				Messages.PassThroughOutboundRouterTypeLabel);
		return figure;
	}
