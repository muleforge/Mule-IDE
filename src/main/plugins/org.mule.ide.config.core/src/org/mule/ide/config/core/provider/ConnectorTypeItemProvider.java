...
/**
 * This is the item provider adapter for a {@link org.mule.ide.config.core.ConnectorType} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ConnectorTypeItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_ConnectorType_createDispatcherPerRequest_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_ConnectorType_createDispatcherPerRequest_feature", "_UI_ConnectorType_type"),
				 CorePackage.eINSTANCE.getConnectorType_CreateDispatcherPerRequest(),
				 true,
				 false,
				 false,
	...
	protected void addCreateMultipleTransactedReceiversPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_ConnectorType_createMultipleTransactedReceivers_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_ConnectorType_createMultipleTransactedReceivers_feature", "_UI_ConnectorType_type"),
				 CorePackage.eINSTANCE.getConnectorType_CreateMultipleTransactedReceivers(),
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.BOOLEAN_VALUE_IMAGE,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(CorePackage.eINSTANCE.getConnectorType_Property());
			childrenFeatures.add(CorePackage.eINSTANCE.getConnectorType_ReceiverThreadingProfile());
			childrenFeatures.add(CorePackage.eINSTANCE.getConnectorType_DispatcherThreadingProfile());
			childrenFeatures.add(CorePackage.eINSTANCE.getConnectorType_AbstractExceptionStrategyGroup());
			childrenFeatures.add(CorePackage.eINSTANCE.getConnectorType_ServiceOverrides());
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(CorePackage.eINSTANCE.getConnectorType_Property(),
				 SpringFactory.eINSTANCE.createPropertyType()));

		newChildDescriptors.add
			(createChildParameter
				(CorePackage.eINSTANCE.getConnectorType_ReceiverThreadingProfile(),
				 CoreFactory.eINSTANCE.createThreadingProfileType()));

		newChildDescriptors.add
			(createChildParameter
				(CorePackage.eINSTANCE.getConnectorType_DispatcherThreadingProfile(),
				 CoreFactory.eINSTANCE.createThreadingProfileType()));
		...
		newChildDescriptors.add
			(createChildParameter
				(CorePackage.eINSTANCE.getConnectorType_ServiceOverrides(),
