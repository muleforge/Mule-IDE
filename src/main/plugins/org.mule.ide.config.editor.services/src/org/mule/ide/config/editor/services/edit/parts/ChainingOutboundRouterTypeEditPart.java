...
import org.mule.ide.config.editor.services.edit.policies.ChainingOutboundRouterTypeItemSemanticEditPolicy;
...
public class ChainingOutboundRouterTypeEditPart extends ShapeNodeEditPart {
	 ...
	 * @generated
	 */
	public ChainingOutboundRouterTypeEditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
							...
							if (request instanceof CreateViewAndElementRequest) {
								...
								if (type == CoreElementTypes.OutboundEndpointType_2031) {
									EditPart compartmentEditPart = getChildBySemanticHint(CoreVisualIDRegistry
											.getType(ChainingOutboundRouterTypeENDPOINTSEditPart.VISUAL_ID));
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new ChainingOutboundRouterTypeItemSemanticEditPolicy());
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof ChainingOutboundRouterTypeLabelEditPart) {
			((ChainingOutboundRouterTypeLabelEditPart) childEditPart)
	...
	protected NodeFigure createNodeFigure() {
		...
		ServiceEditPartUtil.configureServiceItemFigure(figure,
				Messages.ChainingOutboundRouterTypeLabel);
		return figure;
	}
