 ...
 * @generated
 */
public class AxisNavigatorContentProvider implements ICommonContentProvider {
	 ...
	 * @generated
	 */
	public AxisNavigatorContentProvider() {
	...
	public Object[] getChildren(Object parentElement) {
		if (parentElement instanceof IFile) {
			...
			result.addAll(createNavigatorItems(selectViewsByType(resource
					.getContents(), AxisVisualIDRegistry.MODEL_ID), file,
					false));
			return result.toArray();
		}

		if (parentElement instanceof AxisNavigatorGroup) {
			AxisNavigatorGroup group = (AxisNavigatorGroup) parentElement;
			return group.getChildren();
		}

		if (parentElement instanceof AxisNavigatorItem) {
			AxisNavigatorItem navigatorItem = (AxisNavigatorItem) parentElement;
	...
	private Object[] getViewChildren(View view, Object parentElement) {
		...
		case SedaServiceTypeEditPart.VISUAL_ID: {
			Collection result = new ArrayList();
			Collection connectedViews = getChildrenByType(Collections
					.singleton(view), InboundCollectionTypeEditPart.VISUAL_ID);
			result.addAll(createNavigatorItems(connectedViews, parentElement,
					false));
			connectedViews = getChildrenByType(Collections.singleton(view),
					SedaServiceTypeEXCEPTIONEditPart.VISUAL_ID);
			connectedViews = getChildrenByType(connectedViews,
					ExceptionStrategyTypeEditPart.VISUAL_ID);
			result.addAll(createNavigatorItems(connectedViews, parentElement,
					false));
			return result.toArray();
		}
		...
		case ExceptionStrategyTypeEditPart.VISUAL_ID: {
			...
			Collection connectedViews = getChildrenByType(Collections
					.singleton(view),
					ExceptionStrategyTypeENDPOINTSEditPart.VISUAL_ID);
			connectedViews = getChildrenByType(connectedViews,
	...
	private Collection getLinksSourceByType(Collection edges, int visualID) {
		Collection result = new ArrayList();
		String type = AxisVisualIDRegistry.getType(visualID);
	...
	private Collection createNavigatorItems(Collection views, Object parent,
		...
		for (Iterator it = views.iterator(); it.hasNext();) {
			result
					.add(new AxisNavigatorItem((View) it.next(), parent,
							isLeafs));
		}
		return result;
	}
	...
	public Object getParent(Object element) {
		if (element instanceof AxisAbstractNavigatorItem) {
			AxisAbstractNavigatorItem abstractNavigatorItem = (AxisAbstractNavigatorItem) element;
