 ...
 */
public class IdempotentReceiverRouterTypeCreateCommand extends
		SubstitutionElementCreateCommand {

	/**
	 * @generated
	 */
	public IdempotentReceiverRouterTypeCreateCommand(CreateElementRequest req) {
		super(req);
	}
	...
	protected void addSubstitutionElementReference(EObject container,
		...
		map.add(CorePackage.eINSTANCE
				.getDocumentRoot_IdempotentReceiverRouter(), element);
	}
}
