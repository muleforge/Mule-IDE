...
import org.mule.ide.config.vm.editor.services.edit.policies.InboundCollectionTypeItemSemanticEditPolicy;
					...
					public Command getCommand(Request request) {
						if (understandsRequest(request)) {
							if (request instanceof CreateViewAndElementRequest) {
								...
								if (type == VMElementTypes.InboundEndpointType_2002) {
