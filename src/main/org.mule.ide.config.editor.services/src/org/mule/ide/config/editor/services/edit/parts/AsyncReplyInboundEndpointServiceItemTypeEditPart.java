...
import org.mule.ide.config.editor.services.edit.policies.AsyncReplyInboundEndpointServiceItemTypeItemSemanticEditPolicy;
 ...
 * @generated
 */
public class AsyncReplyInboundEndpointServiceItemTypeEditPart extends
		ShapeNodeEditPart {
	 ...
	 * @generated
	 */
	public AsyncReplyInboundEndpointServiceItemTypeEditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(
				...
				new AsyncReplyInboundEndpointServiceItemTypeItemSemanticEditPolicy());
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof AsyncReplyInboundEndpointServiceItemTypeLabelEditPart) {
			((AsyncReplyInboundEndpointServiceItemTypeLabelEditPart) childEditPart)
	...
	protected NodeFigure createNodeFigure() {
		...
		ServiceEditPartUtil.configureServiceItemFigure(figure,
				Messages.AsyncReplyInboundEndpointServiceItemTypeLabel);
		return figure;
	}
