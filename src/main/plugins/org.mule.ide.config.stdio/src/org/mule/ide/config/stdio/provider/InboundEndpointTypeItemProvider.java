...
/**
 * This is the item provider adapter for a {@link org.mule.ide.config.stdio.InboundEndpointType} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_InboundEndpointType_system_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_InboundEndpointType_system_feature", "_UI_InboundEndpointType_type"),
				 StdioPackage.Literals.INBOUND_ENDPOINT_TYPE__SYSTEM,
				 true,
				 false,
				 false,
