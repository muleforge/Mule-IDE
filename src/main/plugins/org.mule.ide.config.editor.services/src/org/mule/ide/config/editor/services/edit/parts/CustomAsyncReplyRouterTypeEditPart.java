...
import org.mule.ide.config.editor.services.edit.policies.CustomAsyncReplyRouterTypeItemSemanticEditPolicy;
 ...
 * customization
 */
public class CustomAsyncReplyRouterTypeEditPart extends ServiceItemNodeEditPart {
	 ...
	 * @generated
	 */
	public CustomAsyncReplyRouterTypeEditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new CustomAsyncReplyRouterTypeItemSemanticEditPolicy());
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof CustomAsyncReplyRouterTypeLabelEditPart) {
			((CustomAsyncReplyRouterTypeLabelEditPart) childEditPart)
					.setLabel(getPrimaryShape()
							.getFigureClassServiceItemTypeLabelFigure());
			return true;
		}
		if (childEditPart instanceof CustomAsyncReplyRouterTypeClassEditPart) {
			((CustomAsyncReplyRouterTypeClassEditPart) childEditPart)
					.setLabel(getPrimaryShape()
	...
	protected NodeFigure createNodeFigure() {
		...
		ServiceEditPartUtil.configureServiceItemFigure(figure,
				Messages.CustomAsyncReplyRouterTypeLabel);
		return figure;
	}
