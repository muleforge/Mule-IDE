...
public class InboundEndpointServiceItemTypeLabelEditPart extends
	...
	protected Image getLabelIcon() {
		...
		return AxisElementTypes.getImage(parserElement.eClass());
	}
	...
	public void setLabelText(String text) {
		...
		if (pdEditPolicy instanceof AxisTextSelectionEditPolicy) {
			((AxisTextSelectionEditPolicy) pdEditPolicy).refreshFeedback();
		}
	}
	...
	protected DirectEditManager getManager() {
		if (manager == null) {
			setManager(new TextDirectEditManager(this, TextDirectEditManager
					.getTextCellEditorClass(this), AxisEditPartFactory
