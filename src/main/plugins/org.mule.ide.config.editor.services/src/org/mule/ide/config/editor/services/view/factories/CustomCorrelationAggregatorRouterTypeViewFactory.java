 ...
 * @generated
 */
public class CustomCorrelationAggregatorRouterTypeViewFactory extends
	...
	protected void decorateView(View containerView, View view,
		...
		if (semanticHint == null) {
			semanticHint = CoreVisualIDRegistry
					.getType(CustomCorrelationAggregatorRouterTypeEditPart.VISUAL_ID);
		...
		getViewService()
				.createNode(
						...
						view,
						CoreVisualIDRegistry
								.getType(CustomCorrelationAggregatorRouterTypeClassEditPart.VISUAL_ID),
						ViewUtil.APPEND, true, getPreferencesHint());
	}
}
