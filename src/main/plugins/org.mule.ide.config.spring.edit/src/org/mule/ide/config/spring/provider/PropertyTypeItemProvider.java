...
/**
 * This is the item provider adapter for a {@link org.mule.ide.config.spring.PropertyType} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class PropertyTypeItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 SpringPackage.Literals.PROPERTY_TYPE__NAME,
				 true,
				 false,
				 false,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 SpringPackage.Literals.PROPERTY_TYPE__REF1,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	protected void addValue1PropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_PropertyType_value1_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_PropertyType_value1_feature", "_UI_PropertyType_type"),
				 SpringPackage.Literals.PROPERTY_TYPE__VALUE1,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(SpringPackage.Literals.PROPERTY_TYPE__DESCRIPTION);
			childrenFeatures.add(SpringPackage.Literals.PROPERTY_TYPE__META);
			childrenFeatures.add(SpringPackage.Literals.PROPERTY_TYPE__BEAN);
			childrenFeatures.add(SpringPackage.Literals.PROPERTY_TYPE__REF);
			childrenFeatures.add(SpringPackage.Literals.PROPERTY_TYPE__IDREF);
			childrenFeatures.add(SpringPackage.Literals.PROPERTY_TYPE__VALUE);
			childrenFeatures.add(SpringPackage.Literals.PROPERTY_TYPE__NULL);
			childrenFeatures.add(SpringPackage.Literals.PROPERTY_TYPE__LIST);
			childrenFeatures.add(SpringPackage.Literals.PROPERTY_TYPE__SET);
			childrenFeatures.add(SpringPackage.Literals.PROPERTY_TYPE__MAP);
			childrenFeatures.add(SpringPackage.Literals.PROPERTY_TYPE__PROPS);
			childrenFeatures.add(SpringPackage.Literals.PROPERTY_TYPE__ANY);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(SpringPackage.Literals.PROPERTY_TYPE__DESCRIPTION,
				 SpringFactory.eINSTANCE.createDescriptionType()));

		newChildDescriptors.add
			(createChildParameter
				(SpringPackage.Literals.PROPERTY_TYPE__META,
				 SpringFactory.eINSTANCE.createMetaType()));

		newChildDescriptors.add
			(createChildParameter
				(SpringPackage.Literals.PROPERTY_TYPE__BEAN,
				 SpringFactory.eINSTANCE.createBeanType()));

		newChildDescriptors.add
			(createChildParameter
				(SpringPackage.Literals.PROPERTY_TYPE__REF,
				 SpringFactory.eINSTANCE.createRefType()));

		newChildDescriptors.add
			(createChildParameter
				(SpringPackage.Literals.PROPERTY_TYPE__IDREF,
				 SpringFactory.eINSTANCE.createIdrefType()));

		newChildDescriptors.add
			(createChildParameter
				(SpringPackage.Literals.PROPERTY_TYPE__VALUE,
				 SpringFactory.eINSTANCE.createValueType()));

		newChildDescriptors.add
			(createChildParameter
				(SpringPackage.Literals.PROPERTY_TYPE__NULL,
				 SpringFactory.eINSTANCE.createNullType()));

		newChildDescriptors.add
			(createChildParameter
				(SpringPackage.Literals.PROPERTY_TYPE__LIST,
				 SpringFactory.eINSTANCE.createListOrSetType()));

		newChildDescriptors.add
			(createChildParameter
				(SpringPackage.Literals.PROPERTY_TYPE__SET,
				 SpringFactory.eINSTANCE.createListOrSetType()));

		newChildDescriptors.add
			(createChildParameter
				(SpringPackage.Literals.PROPERTY_TYPE__MAP,
				 SpringFactory.eINSTANCE.createMapType()));

		newChildDescriptors.add
			(createChildParameter
				(SpringPackage.Literals.PROPERTY_TYPE__PROPS,
	...
	public String getCreateChildText(Object owner, Object feature, Object child, Collection<?> selection) {
		...
		boolean qualify =
			childFeature == SpringPackage.Literals.PROPERTY_TYPE__LIST ||
			childFeature == SpringPackage.Literals.PROPERTY_TYPE__SET;
