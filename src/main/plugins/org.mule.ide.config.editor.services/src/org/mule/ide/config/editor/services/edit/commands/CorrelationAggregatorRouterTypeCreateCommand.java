 ...
 */
public class CorrelationAggregatorRouterTypeCreateCommand extends
		SubstitutionElementCreateCommand {

	/**
	 * @generated
	 */
	public CorrelationAggregatorRouterTypeCreateCommand(CreateElementRequest req) {
		super(req);
	}
	...
	protected void addSubstitutionElementReference(EObject container,
		...
		map.add(CorePackage.eINSTANCE
				.getDocumentRoot_CorrelationAggregatorRouter(), element);
	}
}
