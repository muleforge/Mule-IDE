...
/**
 * Helper class to load namespace information from the <code>spring.handlers</code>
 * and <code>spring.schemas</code> files inside a Jar.
 */
class NamespaceLoader
{
    ...
    private String lookupLocationInSpringSchemas(String uri)
    {
        for (Object key : springSchemas.keySet())
        {
            ...
            {
                // some transports come in a normal and a secure format, e.g. smtp
                // and smtps
        ...
        // this may actually never happen, otherwise the spring.handlers and
        // spring.schemas files
