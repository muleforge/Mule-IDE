...
import org.mule.ide.config.editor.services.edit.policies.MulticastingOutboundRouterTypeItemSemanticEditPolicy;
 ...
 * @generated
 */
public class MulticastingOutboundRouterTypeEditPart extends ShapeNodeEditPart {
	 ...
	 * @generated
	 */
	public MulticastingOutboundRouterTypeEditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
							...
							if (request instanceof CreateViewAndElementRequest) {
								...
								if (type == CoreElementTypes.OutboundEndpointType_2031) {
									EditPart compartmentEditPart = getChildBySemanticHint(CoreVisualIDRegistry
											.getType(MulticastingOutboundRouterTypeENDPOINTSEditPart.VISUAL_ID));
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new MulticastingOutboundRouterTypeItemSemanticEditPolicy());
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof MulticastingOutboundRouterTypeLabelEditPart) {
			((MulticastingOutboundRouterTypeLabelEditPart) childEditPart)
	...
	protected NodeFigure createNodeFigure() {
		...
		ServiceEditPartUtil.configureServiceItemFigure(figure,
				Messages.MulticastingOutboundRouterTypeLabel);
		return figure;
	}
