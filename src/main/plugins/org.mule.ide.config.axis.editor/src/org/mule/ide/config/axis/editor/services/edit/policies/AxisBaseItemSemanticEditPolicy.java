...
import org.mule.ide.config.axis.editor.services.edit.helpers.AxisBaseEditHelper;
import org.mule.ide.config.axis.editor.services.part.AxisVisualIDRegistry;

/**
 * @generated
 */
public class AxisBaseItemSemanticEditPolicy extends SemanticEditPolicy {
	...
	public Command getCommand(Request request) {
		if (request instanceof ReconnectRequest) {
			...
			if (view instanceof View) {
				Integer id = new Integer(AxisVisualIDRegistry
	...
	protected Command getSemanticCommand(IEditCommandRequest request) {
		...
		if (semanticCommand != null) {
			...
			completedRequest.setParameter(
					AxisBaseEditHelper.EDIT_POLICY_COMMAND, command);
		}
		if (elementType != null) {
