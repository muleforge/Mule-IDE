...
public class StdioSwitch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case StdioPackage.DOCUMENT_ROOT: {
				DocumentRoot documentRoot = (DocumentRoot)theEObject;
				T result = caseDocumentRoot(documentRoot);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case StdioPackage.GLOBAL_ENDPOINT_TYPE: {
			...
			case StdioPackage.INBOUND_ENDPOINT_TYPE: {
			...
			case StdioPackage.OUTBOUND_ENDPOINT_TYPE: {
			...
			case StdioPackage.STDIO_CONNECTOR_TYPE: {
				StdioConnectorType stdioConnectorType = (StdioConnectorType)theEObject;
				T result = caseStdioConnectorType(stdioConnectorType);
				if (result == null) result = caseConnectorType(stdioConnectorType);
				if (result == null) result = caseAbstractConnectorType(stdioConnectorType);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
	 ...
	 * @generated
	 */
	public T caseStdioConnectorType(StdioConnectorType object) {
		return null;
	}
