...
/**
 * This is the item provider adapter for a {@link org.mule.ide.config.core.EndpointSelectorRouterType} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class EndpointSelectorRouterTypeItemProvider
	 ...
	 * @generated
	 */
	public EndpointSelectorRouterTypeItemProvider(AdapterFactory adapterFactory) {
	...
	public List<IItemPropertyDescriptor> getPropertyDescriptors(Object object) {
		if (itemPropertyDescriptors == null) {
			...
			addSelectorPropertyPropertyDescriptor(object);
		}
		return itemPropertyDescriptors;
	}

	/**
	 * This adds a property descriptor for the Selector Property feature.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	protected void addSelectorPropertyPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_EndpointSelectorRouterType_selectorProperty_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_EndpointSelectorRouterType_selectorProperty_feature", "_UI_EndpointSelectorRouterType_type"),
				 CorePackage.eINSTANCE.getEndpointSelectorRouterType_SelectorProperty(),
				 true,
				 false,
				 false,
	...
	/**
	 * This returns EndpointSelectorRouterType.gif.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/EndpointSelectorRouterType"));
	}
	...
	public String getText(Object object) {
		EnableCorrelationType labelValue = ((EndpointSelectorRouterType)object).getEnableCorrelation();
		String label = labelValue == null ? null : labelValue.toString();
		return label == null || label.length() == 0 ?
			getString("_UI_EndpointSelectorRouterType_type") :
			getString("_UI_EndpointSelectorRouterType_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(EndpointSelectorRouterType.class)) {
