...
import org.mule.ide.config.editor.services.edit.policies.SelectiveConsumerRouterTypeItemSemanticEditPolicy;
 ...
 * @generated
 */
public class SelectiveConsumerRouterTypeEditPart extends ShapeNodeEditPart {
	 ...
	 * @generated
	 */
	public SelectiveConsumerRouterTypeEditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new SelectiveConsumerRouterTypeItemSemanticEditPolicy());
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof SelectiveConsumerRouterTypeLabelEditPart) {
			((SelectiveConsumerRouterTypeLabelEditPart) childEditPart)
	...
	protected NodeFigure createNodeFigure() {
		...
		ServiceEditPartUtil.configureServiceItemFigure(figure,
				Messages.SelectiveConsumerRouterTypeLabel);
		return figure;
	}
