...
/**
 * This is the item provider adapter for a {@link org.mule.ide.config.core.PropertiesContainerContextType} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class PropertiesContainerContextTypeItemProvider
	 ...
	 * @generated
	 */
	public PropertiesContainerContextTypeItemProvider(AdapterFactory adapterFactory) {
	...
	public List<IItemPropertyDescriptor> getPropertyDescriptors(Object object) {
		if (itemPropertyDescriptors == null) {
			...
			addEnableTemplatesPropertyDescriptor(object);
			addIncludeSystemPropertiesPropertyDescriptor(object);
	...
	/**
	 * This adds a property descriptor for the Enable Templates feature.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	protected void addEnableTemplatesPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_PropertiesContainerContextType_enableTemplates_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_PropertiesContainerContextType_enableTemplates_feature", "_UI_PropertiesContainerContextType_type"),
				 CorePackage.eINSTANCE.getPropertiesContainerContextType_EnableTemplates(),
				 true,
				 false,
				 false,
	...
	/**
	 * This adds a property descriptor for the Include System Properties feature.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	protected void addIncludeSystemPropertiesPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_PropertiesContainerContextType_includeSystemProperties_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_PropertiesContainerContextType_includeSystemProperties_feature", "_UI_PropertiesContainerContextType_type"),
				 CorePackage.eINSTANCE.getPropertiesContainerContextType_IncludeSystemProperties(),
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.BOOLEAN_VALUE_IMAGE,
	...
	protected void addNamePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_PropertiesContainerContextType_name_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_PropertiesContainerContextType_name_feature", "_UI_PropertiesContainerContextType_type"),
				 CorePackage.eINSTANCE.getPropertiesContainerContextType_Name(),
				 true,
				 false,
				 false,
	...
	/**
	 * This returns PropertiesContainerContextType.gif.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/PropertiesContainerContextType"));
	}
	...
	public String getText(Object object) {
		String label = ((PropertiesContainerContextType)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_PropertiesContainerContextType_type") :
			getString("_UI_PropertiesContainerContextType_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(PropertiesContainerContextType.class)) {
