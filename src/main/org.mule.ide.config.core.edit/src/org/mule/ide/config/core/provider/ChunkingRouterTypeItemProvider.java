...
/**
 * This is the item provider adapter for a {@link org.mule.ide.config.core.ChunkingRouterType} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ChunkingRouterTypeItemProvider
	 ...
	 * @generated
	 */
	public ChunkingRouterTypeItemProvider(AdapterFactory adapterFactory) {
	...
	public List<IItemPropertyDescriptor> getPropertyDescriptors(Object object) {
		if (itemPropertyDescriptors == null) {
			...
			addNumberOfMessagesPropertyDescriptor(object);
		}
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_ChunkingRouterType_messageSize_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_ChunkingRouterType_messageSize_feature", "_UI_ChunkingRouterType_type"),
				 CorePackage.eINSTANCE.getChunkingRouterType_MessageSize(),
				 true,
				 false,
				 false,
	...
	/**
	 * This adds a property descriptor for the Number Of Messages feature.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	protected void addNumberOfMessagesPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_ChunkingRouterType_numberOfMessages_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_ChunkingRouterType_numberOfMessages_feature", "_UI_ChunkingRouterType_type"),
				 CorePackage.eINSTANCE.getChunkingRouterType_NumberOfMessages(),
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.INTEGRAL_VALUE_IMAGE,
	...
	/**
	 * This returns ChunkingRouterType.gif.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/ChunkingRouterType"));
	}
	...
	public String getText(Object object) {
		EnableCorrelationType labelValue = ((ChunkingRouterType)object).getEnableCorrelation();
		String label = labelValue == null ? null : labelValue.toString();
		return label == null || label.length() == 0 ?
			getString("_UI_ChunkingRouterType_type") :
			getString("_UI_ChunkingRouterType_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(ChunkingRouterType.class)) {
