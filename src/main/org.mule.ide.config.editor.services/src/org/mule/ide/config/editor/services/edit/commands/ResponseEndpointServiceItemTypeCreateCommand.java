 ...
 */
public class ResponseEndpointServiceItemTypeCreateCommand extends
		SubstitutionElementCreateCommand {

	/**
	 * @generated
	 */
	public ResponseEndpointServiceItemTypeCreateCommand(CreateElementRequest req) {
		super(req);
	}
	...
	protected void addSubstitutionElementReference(EObject container,
		...
		FeatureMap map = ((ResponseRouterCollectionType) container)
				.getAbstractResponseEndpointGroup();
		map.add(CorePackage.eINSTANCE.getDocumentRoot_ResponseEndpoint(),
				element);
	}
}
