...
import org.mule.ide.config.editor.services.edit.policies.PassThroughInboundRouterTypeItemSemanticEditPolicy;
 ...
 * @generated
 */
public class PassThroughInboundRouterTypeEditPart extends ShapeNodeEditPart {
	 ...
	 * @generated
	 */
	public PassThroughInboundRouterTypeEditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new PassThroughInboundRouterTypeItemSemanticEditPolicy());
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof PassThroughInboundRouterTypeLabelEditPart) {
			((PassThroughInboundRouterTypeLabelEditPart) childEditPart)
	...
	protected NodeFigure createNodeFigure() {
		...
		ServiceEditPartUtil.configureServiceItemFigure(figure,
				Messages.PassThroughInboundRouterTypeLabel);
		return figure;
	}
