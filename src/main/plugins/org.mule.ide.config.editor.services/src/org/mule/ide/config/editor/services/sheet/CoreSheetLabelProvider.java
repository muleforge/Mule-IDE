package org.mule.ide.config.editor.services.sheet;
 ...
 * @generated
 */
public class CoreSheetLabelProvider extends DecoratingLabelProvider {
	...
	public String getText(Object element) {
		...
		if (selected instanceof CoreNavigatorGroup) {
			return ((CoreNavigatorGroup) selected).getGroupName();
		}
