...
import org.mule.ide.config.editor.services.edit.policies.CustomCorrelationAggregatorRouterTypeItemSemanticEditPolicy;
 ...
 * customization
 */
public class CustomCorrelationAggregatorRouterTypeEditPart extends
	 ...
	 * @generated
	 */
	public CustomCorrelationAggregatorRouterTypeEditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(
				...
				new CustomCorrelationAggregatorRouterTypeItemSemanticEditPolicy());
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof CustomCorrelationAggregatorRouterTypeLabelEditPart) {
			((CustomCorrelationAggregatorRouterTypeLabelEditPart) childEditPart)
					.setLabel(getPrimaryShape()
							.getFigureClassServiceItemTypeLabelFigure());
			return true;
		}
		if (childEditPart instanceof CustomCorrelationAggregatorRouterTypeClassEditPart) {
			((CustomCorrelationAggregatorRouterTypeClassEditPart) childEditPart)
					.setLabel(getPrimaryShape()
	...
	protected NodeFigure createNodeFigure() {
		...
		ServiceEditPartUtil.configureServiceItemFigure(figure,
				Messages.CustomCorrelationAggregatorRouterTypeLabel);
		return figure;
	}
