 ...
 * customization
 */
public class CustomOutboundRouterTypeCreateCommand extends
		CoreElementCreateCommand {

	/**
	 * @generated
	 */
	public CustomOutboundRouterTypeCreateCommand(CreateElementRequest req) {
		super(req);
	}
	...
	protected EReference getContainmentReference() {
		return CorePackage.eINSTANCE.getDocumentRoot_CustomOutboundRouter();
	}
}
