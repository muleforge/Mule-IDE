 ...
 * @generated
 */
public class AxisVisualIDRegistry {

	public final static String MODEL_ID = "Axis"; //$NON-NLS-1$

	/**
	 * @generated
	 */
	private static final String DEBUG_KEY = AxisEditorPlugin.getInstance()
	...
	public static String getModelID(View view) {
		...
		if (element != null) {
			if (element.eClass().getEPackage() instanceof AxisPackage) {
				return MODEL_ID;
			}
		}
	...
	public static int getNodeVisualID(View containerView, EObject domainElement) {
		...
		// Currently, the only container EditParts in the editor come from the
		...
		if (CoreVisualIDRegistry.MODEL_ID.equals(containerModelID)) {
			...
			case AsyncReplyCollectionTypeASYNCREPLYROUTERSEditPart.VISUAL_ID:
				...
				if (AxisPackage.eINSTANCE.getInboundEndpointType().isSuperTypeOf(
			...
			default:
				...
				if (CoreVisualIDRegistry.canContain(containerView, domainElement
						.eClass())) {
					if (AxisPackage.eINSTANCE.getOutboundEndpointType().isSuperTypeOf(
							domainElement.eClass())) {
