package org.mule.ide.config.vm.editor.services.view.factories;
 ...
 * @generated
 */
public class ExceptionStrategyTypeViewFactory extends AbstractShapeViewFactory {
	...
	protected void decorateView(View containerView, View view,
		...
		if (semanticHint == null) {
			semanticHint = VMVisualIDRegistry
					.getType(ExceptionStrategyTypeEditPart.VISUAL_ID);
