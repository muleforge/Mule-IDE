 ...
 *   <li>{@link org.mule.ide.config.jms.InboundEndpointType#getAbstractConnectionStrategyGroup <em>Abstract Connection Strategy Group</em>}</li>
 *   <li>{@link org.mule.ide.config.jms.InboundEndpointType#getAbstractConnectionStrategy <em>Abstract Connection Strategy</em>}</li>
...
public interface InboundEndpointType extends AbstractInboundEndpointType {
	 ...
	 * @see org.mule.ide.config.jms.JMSPackage#getInboundEndpointType_AbstractConnectionStrategyGroup()
	 * @model unique="false" dataType="org.eclipse.emf.ecore.EFeatureMapEntry" many="true" transient="true" volatile="true" derived="true"
	 ...
	 * @see org.mule.ide.config.jms.JMSPackage#getInboundEndpointType_AbstractConnectionStrategy()
	 * @model containment="true" transient="true" changeable="false" volatile="true" derived="true"
