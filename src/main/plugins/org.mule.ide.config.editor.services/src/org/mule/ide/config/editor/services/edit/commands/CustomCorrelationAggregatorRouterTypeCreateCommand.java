 ...
 */
public class CustomCorrelationAggregatorRouterTypeCreateCommand extends
		SubstitutionElementCreateCommand {

	/**
	 * @generated
	 */
	public CustomCorrelationAggregatorRouterTypeCreateCommand(
	...
	protected void addSubstitutionElementReference(EObject container,
		...
		map.add(CorePackage.eINSTANCE
				.getDocumentRoot_CustomCorrelationAggregatorRouter(), element);
	}
}
