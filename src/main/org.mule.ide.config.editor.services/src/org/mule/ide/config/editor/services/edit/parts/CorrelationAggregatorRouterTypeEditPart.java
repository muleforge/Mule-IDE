...
import org.mule.ide.config.editor.services.edit.policies.CorrelationAggregatorRouterTypeItemSemanticEditPolicy;
 ...
 * @generated
 */
public class CorrelationAggregatorRouterTypeEditPart extends ShapeNodeEditPart {
	 ...
	 * @generated
	 */
	public CorrelationAggregatorRouterTypeEditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new CorrelationAggregatorRouterTypeItemSemanticEditPolicy());
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof CorrelationAggregatorRouterTypeLabelEditPart) {
			((CorrelationAggregatorRouterTypeLabelEditPart) childEditPart)
	...
	protected NodeFigure createNodeFigure() {
		...
		ServiceEditPartUtil.configureServiceItemFigure(figure,
				Messages.CorrelationAggregatorRouterTypeLabel);
		return figure;
	}
