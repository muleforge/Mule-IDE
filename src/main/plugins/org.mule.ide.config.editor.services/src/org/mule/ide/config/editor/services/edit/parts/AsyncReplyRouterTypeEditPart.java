...
import org.mule.ide.config.editor.services.edit.policies.AsyncReplyRouterTypeItemSemanticEditPolicy;
 ...
 * customization
 */
public class AsyncReplyRouterTypeEditPart extends ServiceItemNodeEditPart {
	 ...
	 * @generated
	 */
	public AsyncReplyRouterTypeEditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new AsyncReplyRouterTypeItemSemanticEditPolicy());
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof AsyncReplyRouterTypeLabelEditPart) {
			((AsyncReplyRouterTypeLabelEditPart) childEditPart)
	...
	protected NodeFigure createNodeFigure() {
		...
		ServiceEditPartUtil.configureServiceItemFigure(figure,
				Messages.SingleAsyncReplyRouterTypeLabel);
		return figure;
	}
