...
public class InboundEndpointServiceItemTypeLabelEditPart extends
	...
	public void setLabelText(String text) {
		...
		if (pdEditPolicy instanceof VMTextSelectionEditPolicy) {
			((VMTextSelectionEditPolicy) pdEditPolicy).refreshFeedback();
		}
	}
	...
	protected DirectEditManager getManager() {
		if (manager == null) {
			setManager(new TextDirectEditManager(this, TextDirectEditManager
					.getTextCellEditorClass(this), VMEditPartFactory
