...
public class MulePreferences
{
    ...
    public static String getDefaultDistributionPath()
    {
        ...
        {
            // unfortunately, getDefaultDistributionIndex() returns 0 if pref is
            // undefined
            return null;
        }
        else
     ...
     * 
     * @param path is either a proper filesystem path or a pathified path in case a
     *            different library is selected when creating a project.
