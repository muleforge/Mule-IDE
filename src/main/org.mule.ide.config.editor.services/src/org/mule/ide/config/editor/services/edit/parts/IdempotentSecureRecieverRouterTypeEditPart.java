...
import org.mule.ide.config.editor.services.edit.policies.IdempotentSecureRecieverRouterTypeItemSemanticEditPolicy;
 ...
 * @generated
 */
public class IdempotentSecureRecieverRouterTypeEditPart extends
		ShapeNodeEditPart {
	 ...
	 * @generated
	 */
	public IdempotentSecureRecieverRouterTypeEditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new IdempotentSecureRecieverRouterTypeItemSemanticEditPolicy());
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof IdempotentSecureRecieverRouterTypeLabelEditPart) {
			((IdempotentSecureRecieverRouterTypeLabelEditPart) childEditPart)
	...
	protected NodeFigure createNodeFigure() {
		...
		ServiceEditPartUtil.configureServiceItemFigure(figure,
				Messages.IdempotentSecureReceiverRouterTypeLabel);
		return figure;
	}
