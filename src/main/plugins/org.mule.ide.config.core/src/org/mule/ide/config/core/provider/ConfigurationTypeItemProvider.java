...
/**
 * This is the item provider adapter for a {@link org.mule.ide.config.core.ConfigurationType} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ConfigurationTypeItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_ConfigurationType_defaultRemoteSync_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_ConfigurationType_defaultRemoteSync_feature", "_UI_ConfigurationType_type"),
				 CorePackage.eINSTANCE.getConfigurationType_DefaultRemoteSync(),
				 true,
				 false,
				 false,
	...
	protected void addDefaultSynchronousEndpointsPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_ConfigurationType_defaultSynchronousEndpoints_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_ConfigurationType_defaultSynchronousEndpoints_feature", "_UI_ConfigurationType_type"),
				 CorePackage.eINSTANCE.getConfigurationType_DefaultSynchronousEndpoints(),
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.BOOLEAN_VALUE_IMAGE,
	...
	protected void addDefaultSynchronousEventTimeoutPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_ConfigurationType_defaultSynchronousEventTimeout_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_ConfigurationType_defaultSynchronousEventTimeout_feature", "_UI_ConfigurationType_type"),
				 CorePackage.eINSTANCE.getConfigurationType_DefaultSynchronousEventTimeout(),
				 true,
				 false,
				 false,
	...
	protected void addDefaultTransactionTimeoutPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_ConfigurationType_defaultTransactionTimeout_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_ConfigurationType_defaultTransactionTimeout_feature", "_UI_ConfigurationType_type"),
				 CorePackage.eINSTANCE.getConfigurationType_DefaultTransactionTimeout(),
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(CorePackage.eINSTANCE.getConfigurationType_DefaultThreadingProfile());
	...
	public String getText(Object object) {
		...
		return getString("_UI_ConfigurationType_type") + " " + configurationType.isDefaultRemoteSync();
	}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(CorePackage.eINSTANCE.getConfigurationType_DefaultThreadingProfile(),
				 CoreFactory.eINSTANCE.createThreadingProfileType()));

		newChildDescriptors.add
			(createChildParameter
				(CorePackage.eINSTANCE.getConfigurationType_DefaultDispatcherThreadingProfile(),
				 CoreFactory.eINSTANCE.createThreadingProfileType()));

		newChildDescriptors.add
			(createChildParameter
				(CorePackage.eINSTANCE.getConfigurationType_DefaultReceiverThreadingProfile(),
				 CoreFactory.eINSTANCE.createThreadingProfileType()));
	...
	public String getCreateChildText(Object owner, Object feature, Object child, Collection<?> selection) {
		...
		boolean qualify =
			childFeature == CorePackage.eINSTANCE.getConfigurationType_DefaultThreadingProfile() ||
			childFeature == CorePackage.eINSTANCE.getConfigurationType_DefaultDispatcherThreadingProfile() ||
			childFeature == CorePackage.eINSTANCE.getConfigurationType_DefaultReceiverThreadingProfile() ||
			childFeature == CorePackage.eINSTANCE.getConfigurationType_DefaultComponentThreadingProfile();
