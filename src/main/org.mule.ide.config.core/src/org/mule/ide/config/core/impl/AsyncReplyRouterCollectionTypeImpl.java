...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Async Reply Router Collection Type</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * <ul>
 *   <li>{@link org.mule.ide.config.core.impl.AsyncReplyRouterCollectionTypeImpl#getAbstractInboundEndpointGroup <em>Abstract Inbound Endpoint Group</em>}</li>
 *   <li>{@link org.mule.ide.config.core.impl.AsyncReplyRouterCollectionTypeImpl#getAbstractInboundEndpoint <em>Abstract Inbound Endpoint</em>}</li>
 *   <li>{@link org.mule.ide.config.core.impl.AsyncReplyRouterCollectionTypeImpl#getAbstractAsyncReplyRouterGroup <em>Abstract Async Reply Router Group</em>}</li>
 *   <li>{@link org.mule.ide.config.core.impl.AsyncReplyRouterCollectionTypeImpl#getAbstractAsyncReplyRouter <em>Abstract Async Reply Router</em>}</li>
 *   <li>{@link org.mule.ide.config.core.impl.AsyncReplyRouterCollectionTypeImpl#getAbstractTransformerGroup <em>Abstract Transformer Group</em>}</li>
 *   <li>{@link org.mule.ide.config.core.impl.AsyncReplyRouterCollectionTypeImpl#getAbstractTransformer <em>Abstract Transformer</em>}</li>
 *   <li>{@link org.mule.ide.config.core.impl.AsyncReplyRouterCollectionTypeImpl#getTimeout <em>Timeout</em>}</li>
 *   <li>{@link org.mule.ide.config.core.impl.AsyncReplyRouterCollectionTypeImpl#getTransformerRefs <em>Transformer Refs</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class AsyncReplyRouterCollectionTypeImpl extends EObjectImpl implements AsyncReplyRouterCollectionType {
	/**
	 ...
	 * @generated
	 */
	protected AsyncReplyRouterCollectionTypeImpl() {
		super();
	}
	...
	public FeatureMap getAbstractInboundEndpointGroup() {
		if (abstractInboundEndpointGroup == null) {
			abstractInboundEndpointGroup = new BasicFeatureMap(this, CorePackage.ASYNC_REPLY_ROUTER_COLLECTION_TYPE__ABSTRACT_INBOUND_ENDPOINT_GROUP);
		}
	...
	public EList<AbstractInboundEndpointType> getAbstractInboundEndpoint() {
		return getAbstractInboundEndpointGroup().list(CorePackage.eINSTANCE.getAsyncReplyRouterCollectionType_AbstractInboundEndpoint());
	}
	...
	public FeatureMap getAbstractAsyncReplyRouterGroup() {
		if (abstractAsyncReplyRouterGroup == null) {
			abstractAsyncReplyRouterGroup = new BasicFeatureMap(this, CorePackage.ASYNC_REPLY_ROUTER_COLLECTION_TYPE__ABSTRACT_ASYNC_REPLY_ROUTER_GROUP);
		}
	...
	public EList<AbstractAsyncReplyRouterType> getAbstractAsyncReplyRouter() {
		return getAbstractAsyncReplyRouterGroup().list(CorePackage.eINSTANCE.getAsyncReplyRouterCollectionType_AbstractAsyncReplyRouter());
	}
	...
	public FeatureMap getAbstractTransformerGroup() {
		if (abstractTransformerGroup == null) {
			abstractTransformerGroup = new BasicFeatureMap(this, CorePackage.ASYNC_REPLY_ROUTER_COLLECTION_TYPE__ABSTRACT_TRANSFORMER_GROUP);
		}
	...
	public EList<AbstractTransformerType> getAbstractTransformer() {
		return getAbstractTransformerGroup().list(CorePackage.eINSTANCE.getAsyncReplyRouterCollectionType_AbstractTransformer());
	}
	...
	public void setTimeout(String newTimeout) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CorePackage.ASYNC_REPLY_ROUTER_COLLECTION_TYPE__TIMEOUT, oldTimeout, timeout));
	}
	...
	public void setTransformerRefs(List<String> newTransformerRefs) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CorePackage.ASYNC_REPLY_ROUTER_COLLECTION_TYPE__TRANSFORMER_REFS, oldTransformerRefs, transformerRefs));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case CorePackage.ASYNC_REPLY_ROUTER_COLLECTION_TYPE__ABSTRACT_INBOUND_ENDPOINT_GROUP:
				return ((InternalEList<?>)getAbstractInboundEndpointGroup()).basicRemove(otherEnd, msgs);
			case CorePackage.ASYNC_REPLY_ROUTER_COLLECTION_TYPE__ABSTRACT_INBOUND_ENDPOINT:
				return ((InternalEList<?>)getAbstractInboundEndpoint()).basicRemove(otherEnd, msgs);
			case CorePackage.ASYNC_REPLY_ROUTER_COLLECTION_TYPE__ABSTRACT_ASYNC_REPLY_ROUTER_GROUP:
				return ((InternalEList<?>)getAbstractAsyncReplyRouterGroup()).basicRemove(otherEnd, msgs);
			case CorePackage.ASYNC_REPLY_ROUTER_COLLECTION_TYPE__ABSTRACT_ASYNC_REPLY_ROUTER:
				return ((InternalEList<?>)getAbstractAsyncReplyRouter()).basicRemove(otherEnd, msgs);
			case CorePackage.ASYNC_REPLY_ROUTER_COLLECTION_TYPE__ABSTRACT_TRANSFORMER_GROUP:
				return ((InternalEList<?>)getAbstractTransformerGroup()).basicRemove(otherEnd, msgs);
			case CorePackage.ASYNC_REPLY_ROUTER_COLLECTION_TYPE__ABSTRACT_TRANSFORMER:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			...
			case CorePackage.ASYNC_REPLY_ROUTER_COLLECTION_TYPE__TIMEOUT:
				return getTimeout();
			case CorePackage.ASYNC_REPLY_ROUTER_COLLECTION_TYPE__TRANSFORMER_REFS:
...
} //AsyncReplyRouterCollectionTypeImpl
