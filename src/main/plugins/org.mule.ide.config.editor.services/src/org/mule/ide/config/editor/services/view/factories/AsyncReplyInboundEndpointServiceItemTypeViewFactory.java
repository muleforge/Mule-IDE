 ...
 * @generated
 */
public class AsyncReplyInboundEndpointServiceItemTypeViewFactory extends
	...
	protected void decorateView(View containerView, View view,
		...
		if (semanticHint == null) {
			semanticHint = CoreVisualIDRegistry
					.getType(AsyncReplyInboundEndpointServiceItemTypeEditPart.VISUAL_ID);
		...
		getViewService()
				.createNode(
						...
						view,
						CoreVisualIDRegistry
								.getType(AsyncReplyInboundEndpointServiceItemEndpointNameEditPart.VISUAL_ID),
						ViewUtil.APPEND, true, getPreferencesHint());
	}
}
