...
import org.mule.ide.config.editor.services.edit.policies.FilteringOutboundRouterTypeItemSemanticEditPolicy;
...
public class FilteringOutboundRouterTypeEditPart extends
	 ...
	 * @generated
	 */
	public FilteringOutboundRouterTypeEditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
							...
							if (request instanceof CreateViewAndElementRequest) {
								...
								if (type == CoreElementTypes.OutboundEndpointType_2030) {
									EditPart compartmentEditPart = getChildBySemanticHint(CoreVisualIDRegistry
											.getType(FilteringOutboundRouterTypeENDPOINTSEditPart.VISUAL_ID));
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new FilteringOutboundRouterTypeItemSemanticEditPolicy());
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof FilteringOutboundRouterTypeLabelEditPart) {
			((FilteringOutboundRouterTypeLabelEditPart) childEditPart)
	...
	protected NodeFigure createNodeFigure() {
		...
		ServiceEditPartUtil.configureServiceItemFigure(figure,
				Messages.FilteringOutboundRouterTypeLabel);
		return figure;
	}
